<a id="velocity-apache-org-dvsl-1-0-index"></a>

# Apache DVSL - 
        DVSL

<a id="velocity-apache-org-dvsl-1-0-index--dvsl_:_declarative_xml_transformation_and_templating"></a>
...
<a id="velocity-apache-org-dvsl-1-0-index--current_status"></a>

## Current Status

DVSL is now mature and usable in production environments.

<a id="velocity-apache-org-dvsl-1-0-index--nightly_snapshots"></a>
...
<a id="velocity-apache-org-dvsl-1-0-index--subversion_access"></a>
...
<a id="velocity-apache-org-dvsl-1-0-ant_task_reference"></a>

# Apache DVSL - 
  DVSL Ant Task Reference

<a id="velocity-apache-org-dvsl-1-0-ant_task_reference--dvsl_ant_task_reference"></a>
...
want to use default exclusions or not. See the section on [directory based tasks](../dirtasks.html#directorybasedtasks), on how the
inclusion/exclusion of files works, and how to write patterns.

This task forms an implicit [FileSet](../CoreTypes/fileset.html) and supports all
...
If the `logfile` attribute is specified to this task,
all Velocity messages are written to the specified log file without
regard to any logging option specified to Ant.

<a id="velocity-apache-org-dvsl-1-0-ant_task_reference--parameters"></a>
...
| classpathref | the classpath to use, given asreferenceto a path defined elsewhere. | No |
...
| velocityconfigclass | specifies a class to load which sets Velocity properties.           The class must implement thejava.util.Mapinterface. | No |
| validatingparser | specifies that the parser for the input XML should         validate.  Boolean valued, default isfalse | No |

<a id="velocity-apache-org-dvsl-1-0-ant_task_reference--parameters_specified_as_nested_elements"></a>

## Parameters specified as nested elements

<a id="velocity-apache-org-dvsl-1-0-ant_task_reference--classpath"></a>

### classpath

Classpath to use when loading toolbox and velocity configuration
classes. This is defined using a
[path](../using.html#path)-like structure.

<a id="velocity-apache-org-dvsl-1-0-ant_task_reference--tool"></a>
...
<a id="velocity-apache-org-dvsl-1-0-ant_task_reference--velconfig"></a>
...
<a id="velocity-apache-org-dvsl-1-0-ant_task_reference--application_values"></a>
...
<a id="velocity-apache-org-dvsl-1-0-ant_task_reference--declaring_the_dvsl_task_in_the_build_file"></a>
...
with the class `org.apache.dvsl.DVSLTask`. In addition,
...
<a id="velocity-apache-org-dvsl-1-0-ant_task_reference--examples"></a>
...
<a id="velocity-apache-org-dvsl-1-0-more-resources"></a>

# Apache DVSL - 
        More Resources

[
![](velocity.apache.org/dvsl/1.0/images/velocity_project_wide.png)
](../../../)

![](velocity.apache.org/dvsl/1.0/images/dvsl.png)
...
- [General](#velocity-apache-org-dvsl-1-0-index)
- [Download](../../../download.cgi)

##### Documentation

- [User Guide](#velocity-apache-org-dvsl-1-0-users-guide)
- [Ant Task Reference](#velocity-apache-org-dvsl-1-0-ant_task_reference)
- **More Resources**
...
- [Issues](https://issues.apache.org/jira/browse/DVSL)
...
[![Apache Velocity](velocity.apache.org/dvsl/1.0/images/pbv90x30.png)](../../../ "Apache Velocity")
[![Velocity News Feed](velocity.apache.org/dvsl/1.0/images/feed-icon-24x24.jpg)](../../../rss/news.rss "Velocity News Feed")

<a id="velocity-apache-org-dvsl-1-0-more-resources--more_information"></a>
...
<a id="velocity-apache-org-dvsl-1-0-users-guide"></a>

# Apache DVSL - 
  DVSL User Guide

<a id="velocity-apache-org-dvsl-1-0-users-guide--dvsl_user_guide"></a>
...
DVSL's template language is [
Velocity](http://velocity.apache.org/engine/devel/vtl-reference-guide.html), so conventional Velocity syntax is
...
<a id="velocity-apache-org-dvsl-1-0-users-guide--getting_started_:_building_and_using"></a>
...
<a id="velocity-apache-org-dvsl-1-0-users-guide--starting_with_examples"></a>
...
<a id="velocity-apache-org-dvsl-1-0-users-guide--the_template_api"></a>
...
<a id="velocity-apache-org-dvsl-1-0-users-guide--default_template_rules"></a>
