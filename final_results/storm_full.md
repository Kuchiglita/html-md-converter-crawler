<a id="storm-apache-org-releases-2-8-3-index"></a>

# Documentation

[![](storm.apache.org/images/logo.png)](/index.html)
...
- [Project Information](/about/integrates.html)
- [Documentation ](#storm-apache-org-releases-2-8-3-index--)
  - [2.8.7](/releases/2.8.7/index.html)
  - [2.8.6](/releases/2.8.6/index.html)
  - [2.8.5](/releases/2.8.5/index.html)
  - [Older Versions](/older-releases.html)
- [Talks and Slideshows](/talksAndVideos.html)
- [Community ](#storm-apache-org-releases-2-8-3-index--)
  - [Contributing](/contribute/Contributing-to-Storm.html)
  - [People](/contribute/People.html)
  - [ByLaws](/contribute/BYLAWS.html)
  - [PoweredBy](/Powered-By.html)
- [News](/2026/04/25/storm287-released.html)
...
- [Tutorial](#storm-apache-org-releases-2-8-3-tutorial)
- [Concepts](#storm-apache-org-releases-2-8-3-concepts)
- [Scheduler](#storm-apache-org-releases-2-8-3-storm-scheduler)
- [Configuration](#storm-apache-org-releases-2-8-3-configuration)
- [Guaranteeing message processing](#storm-apache-org-releases-2-8-3-guaranteeing-message-processing)
- [Daemon Fault Tolerance](#storm-apache-org-releases-2-8-3-daemon-fault-tolerance)
- [Command line client](#storm-apache-org-releases-2-8-3-command-line-client)
- [REST API](#storm-apache-org-releases-2-8-3-storm-ui-rest-api)
- [Understanding the parallelism of a Storm topology](#storm-apache-org-releases-2-8-3-understanding-the-parallelism-of-a-storm-topology)
- [FAQ](#storm-apache-org-releases-2-8-3-faq)
...
- [Trident Tutorial](#storm-apache-org-releases-2-8-3-trident-tutorial) -- basic concepts and walkthrough
- [Trident API Overview](#storm-apache-org-releases-2-8-3-trident-api-overview) -- operations for transforming and orchestrating data
- [Trident State](#storm-apache-org-releases-2-8-3-trident-state) -- exactly-once processing and fast, persistent aggregation
- [Trident spouts](#storm-apache-org-releases-2-8-3-trident-spouts) -- transactional and non-transactional data intake
- [Trident RAS API](#storm-apache-org-releases-2-8-3-trident-ras-api) -- using the Resource Aware Scheduler with Trident.
...
- [Streams API](#storm-apache-org-releases-2-8-3-stream-api)

#### Flux

- [Flux Data Driven Topology Builder](#storm-apache-org-releases-2-8-3-flux)

### Setup and Deploying

- [Setting up a Storm cluster](#storm-apache-org-releases-2-8-3-setting-up-a-storm-cluster)
- [Local mode](#storm-apache-org-releases-2-8-3-local-mode)
- [Troubleshooting](#storm-apache-org-releases-2-8-3-troubleshooting)
- [Running topologies on a production cluster](#storm-apache-org-releases-2-8-3-running-topologies-on-a-production-cluster)
- [Building Storm](#storm-apache-org-releases-2-8-3-maven) with Maven
- [Setting up a Secure Cluster](#storm-apache-org-releases-2-8-3-security)
- [CGroup Enforcement](#storm-apache-org-releases-2-8-3-cgroups_in_storm)
- [Pacemaker reduces load on zookeeper for large clusters](#storm-apache-org-releases-2-8-3-pacemaker)
- [Resource Aware Scheduler](#storm-apache-org-releases-2-8-3-resource_aware_scheduler_overview)
- [Generic Resources](#storm-apache-org-releases-2-8-3-generic-resources)
- [Daemon Metrics/Monitoring](#storm-apache-org-releases-2-8-3-clustermetrics)
- [Windows users guide](#storm-apache-org-releases-2-8-3-windows-users-guide)
- [Classpath handling](#storm-apache-org-releases-2-8-3-classpath-handling)

### Intermediate

- [Serialization](#storm-apache-org-releases-2-8-3-serialization)
- [Common patterns](#storm-apache-org-releases-2-8-3-common-patterns)
- [DSLs and multilang adapters](#storm-apache-org-releases-2-8-3-dsls-and-multilang-adapters)
- [Using non-JVM languages with Storm](#storm-apache-org-releases-2-8-3-using-non-jvm-languages-with-storm)
- [Distributed RPC](#storm-apache-org-releases-2-8-3-distributed-rpc)
- [Hooks](#storm-apache-org-releases-2-8-3-hooks)
- [Metrics (Deprecated)](#storm-apache-org-releases-2-8-3-metrics)
- [Metrics V2](#storm-apache-org-releases-2-8-3-metrics_v2)
- [State Checkpointing](#storm-apache-org-releases-2-8-3-state-checkpointing)
- [Windowing](#storm-apache-org-releases-2-8-3-windowing)
- [Joining Streams](#storm-apache-org-releases-2-8-3-joins)
- [Blobstore(Distcache)](#storm-apache-org-releases-2-8-3-distcache-blobstore)

### Debugging

- [Dynamic Log Level Settings](#storm-apache-org-releases-2-8-3-dynamic-log-level-settings)
- [Searching Worker Logs](#storm-apache-org-releases-2-8-3-logs)
- [Worker Profiling](#storm-apache-org-releases-2-8-3-dynamic-worker-profiling)
- [Event Logging](#storm-apache-org-releases-2-8-3-eventlogging)

### Integration With External Systems, and Other Libraries

- [Apache Kafka Integration](#storm-apache-org-releases-2-8-3-storm-kafka-client)
- [Apache HBase Integration](storm-hbase.html)
- [Apache HDFS Integration](#storm-apache-org-releases-2-8-3-storm-hdfs)
- [JDBC Integration](#storm-apache-org-releases-2-8-3-storm-jdbc)
- [JMS Integration](#storm-apache-org-releases-2-8-3-storm-jms)
- [Redis Integration](#storm-apache-org-releases-2-8-3-storm-redis)
...
- [Defining a non-JVM language DSL for Storm](#storm-apache-org-releases-2-8-3-defining-a-non-jvm-language-dsl-for-storm)
- [Multilang protocol](#storm-apache-org-releases-2-8-3-multilang-protocol) (how to provide support for another language)
- [Implementation docs](#storm-apache-org-releases-2-8-3-implementation-docs)
- [Storm Metricstore](#storm-apache-org-releases-2-8-3-storm-metricstore)

##### Meetups

[![Apache Events Calendar](https://www.apachecon.com/event-images/current-event-wide-dark.png "Apache Events Calendar")](https://events.apache.org/)
...
- [Rationale](/releases/current/Rationale.html)
- [Tutorial](/releases/current/Tutorial.html)
- [Setting up development environment](/releases/current/Setting-up-development-environment.html)
- [Creating a new Apache Storm project](/releases/current/Creating-a-new-Storm-project.html)

##### Documentation

- [Index](/releases/current/index.html)
- [Javadoc](/releases/current/javadocs/index.html)
- [FAQ](/releases/current/FAQ.html)
...
Copyright © 2026 [Apache Software Foundation](https://www.apache.org)
. All Rights Reserved.
...
[](#storm-apache-org-releases-2-8-3-index--)

---

<a id="storm-apache-org-releases-2-8-3-classpath-handling"></a>
...
- [Security](/security-model.html)
- [Project Information](/about/integrates.html)
- [Documentation ](#storm-apache-org-releases-2-8-3-classpath-handling--)
  - [2.8.7](/releases/2.8.7/index.html)
  - [2.8.6](/releases/2.8.6/index.html)
  - [2.8.5](/releases/2.8.5/index.html)
  - [Older Versions](/older-releases.html)
- [Talks and Slideshows](/talksAndVideos.html)
- [Community ](#storm-apache-org-releases-2-8-3-classpath-handling--)
  - [Contributing](/contribute/Contributing-to-Storm.html)
  - [People](/contribute/People.html)
  - [ByLaws](/contribute/BYLAWS.html)
  - [PoweredBy](/Powered-By.html)
...
[](#storm-apache-org-releases-2-8-3-classpath-handling--)

---

<a id="storm-apache-org-releases-2-8-3-clustermetrics"></a>
...
- [Security](/security-model.html)
- [Project Information](/about/integrates.html)
- [Documentation ](#storm-apache-org-releases-2-8-3-clustermetrics--)
  - [2.8.7](/releases/2.8.7/index.html)
  - [2.8.6](/releases/2.8.6/index.html)
  - [2.8.5](/releases/2.8.5/index.html)
  - [Older Versions](/older-releases.html)
- [Talks and Slideshows](/talksAndVideos.html)
- [Community ](#storm-apache-org-releases-2-8-3-clustermetrics--)
  - [Contributing](/contribute/Contributing-to-Storm.html)
  - [People](/contribute/People.html)
  - [ByLaws](/contribute/BYLAWS.html)
  - [PoweredBy](/Powered-By.html)
...
[](#storm-apache-org-releases-2-8-3-clustermetrics--)

---

<a id="storm-apache-org-releases-2-8-3-command-line-client"></a>
...
- [Security](/security-model.html)
- [Project Information](/about/integrates.html)
- [Documentation ](#storm-apache-org-releases-2-8-3-command-line-client--)
  - [2.8.7](/releases/2.8.7/index.html)
  - [2.8.6](/releases/2.8.6/index.html)
  - [2.8.5](/releases/2.8.5/index.html)
  - [Older Versions](/older-releases.html)
- [Talks and Slideshows](/talksAndVideos.html)
- [Community ](#storm-apache-org-releases-2-8-3-command-line-client--)
  - [Contributing](/contribute/Contributing-to-Storm.html)
  - [People](/contribute/People.html)
  - [ByLaws](/contribute/BYLAWS.html)
  - [PoweredBy](/Powered-By.html)
...
This page describes all the commands that are possible with the "storm" command line client. To learn how to set up your "storm" client to talk to a remote cluster, follow the instructions in [Setting up development environment](#storm-apache-org-releases-2-8-3-setting-up-development-environment). See [Classpath handling](#storm-apache-org-releases-2-8-3-classpath-handling) for details on using external libraries in these commands.
...
Launches the nimbus daemon. This command should be run under supervision with a tool like [daemontools](http://cr.yp.to/daemontools.html) or [monit](http://mmonit.com/monit/). See [Setting up a Storm cluster](#storm-apache-org-releases-2-8-3-setting-up-a-storm-cluster) for more information.

### supervisor

Syntax: `storm supervisor`

Launches the supervisor daemon. This command should be run under supervision with a tool like [daemontools](http://cr.yp.to/daemontools.html) or [monit](http://mmonit.com/monit/). See [Setting up a Storm cluster](#storm-apache-org-releases-2-8-3-setting-up-a-storm-cluster) for more information.

### ui

Syntax: `storm ui`

Launches the UI daemon. The UI provides a web interface for a Storm cluster and shows detailed stats about running topologies. This command should be run under supervision with a tool like [daemontools](http://cr.yp.to/daemontools.html) or [monit](http://mmonit.com/monit/). See [Setting up a Storm cluster](#storm-apache-org-releases-2-8-3-setting-up-a-storm-cluster) for more information.

### drpc

Syntax: `storm drpc`

Launches a DRPC daemon. This command should be run under supervision with a tool like [daemontools](http://cr.yp.to/daemontools.html) or [monit](http://mmonit.com/monit/). See [Distributed RPC](#storm-apache-org-releases-2-8-3-distributed-rpc) for more information.
...
See [Blobstore(Distcahce)](#storm-apache-org-releases-2-8-3-distcache-blobstore) for more information.
...
[](#storm-apache-org-releases-2-8-3-command-line-client--)

---

<a id="storm-apache-org-releases-2-8-3-common-patterns"></a>
...
- [Security](/security-model.html)
- [Project Information](/about/integrates.html)
- [Documentation ](#storm-apache-org-releases-2-8-3-common-patterns--)
  - [2.8.7](/releases/2.8.7/index.html)
  - [2.8.6](/releases/2.8.6/index.html)
  - [2.8.5](/releases/2.8.5/index.html)
  - [Older Versions](/older-releases.html)
- [Talks and Slideshows](/talksAndVideos.html)
- [Community ](#storm-apache-org-releases-2-8-3-common-patterns--)
  - [Contributing](/contribute/Contributing-to-Storm.html)
  - [People](/contribute/People.html)
  - [ByLaws](/contribute/BYLAWS.html)
  - [PoweredBy](/Powered-By.html)
...
See [Distributed RPC](#storm-apache-org-releases-2-8-3-distributed-rpc) for more details.
...
[](#storm-apache-org-releases-2-8-3-common-patterns--)

---

<a id="storm-apache-org-releases-2-8-3-concepts"></a>
...
- [Security](/security-model.html)
- [Project Information](/about/integrates.html)
- [Documentation ](#storm-apache-org-releases-2-8-3-concepts--)
  - [2.8.7](/releases/2.8.7/index.html)
  - [2.8.6](/releases/2.8.6/index.html)
  - [2.8.5](/releases/2.8.5/index.html)
  - [Older Versions](/older-releases.html)
- [Talks and Slideshows](/talksAndVideos.html)
- [Community ](#storm-apache-org-releases-2-8-3-concepts--)
  - [Contributing](/contribute/Contributing-to-Storm.html)
  - [People](/contribute/People.html)
  - [ByLaws](/contribute/BYLAWS.html)
  - [PoweredBy](/Powered-By.html)
...
- [Running topologies on a production cluster](#storm-apache-org-releases-2-8-3-running-topologies-on-a-production-cluster)
- [Local mode](#storm-apache-org-releases-2-8-3-local-mode): Read this to learn how to develop and test topologies in local mode.
...
- [Serialization](#storm-apache-org-releases-2-8-3-serialization): Information about Storm's dynamic typing of tuples and declaring custom serializations
...
This is all explained in much more detail in [Guaranteeing message processing](#storm-apache-org-releases-2-8-3-guaranteeing-message-processing).
...
- [Config.TOPOLOGY\_WORKERS](javadocs/org/apache/storm/Config.html#TOPOLOGY_WORKERS): this config sets the number of workers to allocate for executing the topology

### Performance Tuning

Refer to [performance tuning guide](#storm-apache-org-releases-2-8-3-performance).
...
[](#storm-apache-org-releases-2-8-3-concepts--)

---

<a id="storm-apache-org-releases-2-8-3-configuration"></a>
...
- [Security](/security-model.html)
- [Project Information](/about/integrates.html)
- [Documentation ](#storm-apache-org-releases-2-8-3-configuration--)
  - [2.8.7](/releases/2.8.7/index.html)
  - [2.8.6](/releases/2.8.6/index.html)
  - [2.8.5](/releases/2.8.5/index.html)
  - [Older Versions](/older-releases.html)
- [Talks and Slideshows](/talksAndVideos.html)
- [Community ](#storm-apache-org-releases-2-8-3-configuration--)
  - [Contributing](/contribute/Contributing-to-Storm.html)
  - [People](/contribute/People.html)
  - [ByLaws](/contribute/BYLAWS.html)
  - [PoweredBy](/Powered-By.html)
...
4. "topology.kryo.register": This works a little bit differently than the other ones, since the serializations will be available to all components in the topology. More details on [Serialization](#storm-apache-org-releases-2-8-3-serialization).
...
- [Setting up a Storm cluster](#storm-apache-org-releases-2-8-3-setting-up-a-storm-cluster): explains how to create and configure a Storm cluster
- [Running topologies on a production cluster](#storm-apache-org-releases-2-8-3-running-topologies-on-a-production-cluster): lists useful configurations when running topologies on a cluster
- [Local mode](#storm-apache-org-releases-2-8-3-local-mode): lists useful configurations when using local mode
...
[](#storm-apache-org-releases-2-8-3-configuration--)

---

<a id="storm-apache-org-releases-2-8-3-dsls-and-multilang-adapters"></a>
...
- [Security](/security-model.html)
- [Project Information](/about/integrates.html)
- [Documentation ](#storm-apache-org-releases-2-8-3-dsls-and-multilang-adapters--)
  - [2.8.7](/releases/2.8.7/index.html)
  - [2.8.6](/releases/2.8.6/index.html)
  - [2.8.5](/releases/2.8.5/index.html)
  - [Older Versions](/older-releases.html)
- [Talks and Slideshows](/talksAndVideos.html)
- [Community ](#storm-apache-org-releases-2-8-3-dsls-and-multilang-adapters--)
  - [Contributing](/contribute/Contributing-to-Storm.html)
  - [People](/contribute/People.html)
  - [ByLaws](/contribute/BYLAWS.html)
  - [PoweredBy](/Powered-By.html)
...
- [Clojure DSL](#storm-apache-org-releases-2-8-3-clojure-dsl)
...
[](#storm-apache-org-releases-2-8-3-dsls-and-multilang-adapters--)

---

<a id="storm-apache-org-releases-2-8-3-daemon-fault-tolerance"></a>
...
- [Security](/security-model.html)
- [Project Information](/about/integrates.html)
- [Documentation ](#storm-apache-org-releases-2-8-3-daemon-fault-tolerance--)
  - [2.8.7](/releases/2.8.7/index.html)
  - [2.8.6](/releases/2.8.6/index.html)
  - [2.8.5](/releases/2.8.5/index.html)
  - [Older Versions](/older-releases.html)
- [Talks and Slideshows](/talksAndVideos.html)
- [Community ](#storm-apache-org-releases-2-8-3-daemon-fault-tolerance--)
  - [Contributing](/contribute/Contributing-to-Storm.html)
  - [People](/contribute/People.html)
  - [ByLaws](/contribute/BYLAWS.html)
  - [PoweredBy](/Powered-By.html)
...
The Nimbus and Supervisor daemons are designed to be fail-fast (process self-destructs whenever any unexpected situation is encountered) and stateless (all state is kept in Zookeeper or on disk). As described in [Setting up a Storm cluster](#storm-apache-org-releases-2-8-3-setting-up-a-storm-cluster), the Nimbus and Supervisor daemons must be run under supervision using a tool like daemontools or monit. So if the Nimbus or Supervisor daemons die, they restart like nothing happened.
...
Storm Nimbus is highly available since 1.0.0. More information please refer to [Nimbus HA Design](#storm-apache-org-releases-2-8-3-nimbus-ha-design) document.

## How does Storm guarantee data processing?

Storm provides mechanisms to guarantee data processing even if nodes die or messages are lost. See [Guaranteeing message processing](#storm-apache-org-releases-2-8-3-guaranteeing-message-processing) for the details.
...
[](#storm-apache-org-releases-2-8-3-daemon-fault-tolerance--)

---

<a id="storm-apache-org-releases-2-8-3-defining-a-non-jvm-language-dsl-for-storm"></a>
...
- [Security](/security-model.html)
- [Project Information](/about/integrates.html)
- [Documentation ](#storm-apache-org-releases-2-8-3-defining-a-non-jvm-language-dsl-for-storm--)
  - [2.8.7](/releases/2.8.7/index.html)
  - [2.8.6](/releases/2.8.6/index.html)
  - [2.8.5](/releases/2.8.5/index.html)
  - [Older Versions](/older-releases.html)
- [Talks and Slideshows](/talksAndVideos.html)
- [Community ](#storm-apache-org-releases-2-8-3-defining-a-non-jvm-language-dsl-for-storm--)
  - [Contributing](/contribute/Contributing-to-Storm.html)
  - [People](/contribute/People.html)
  - [ByLaws](/contribute/BYLAWS.html)
  - [PoweredBy](/Powered-By.html)
...
[](#storm-apache-org-releases-2-8-3-defining-a-non-jvm-language-dsl-for-storm--)

---

<a id="storm-apache-org-releases-2-8-3-distributed-rpc"></a>
...
- [Security](/security-model.html)
- [Project Information](/about/integrates.html)
- [Documentation ](#storm-apache-org-releases-2-8-3-distributed-rpc--)
  - [2.8.7](/releases/2.8.7/index.html)
  - [2.8.6](/releases/2.8.6/index.html)
  - [2.8.5](/releases/2.8.5/index.html)
  - [Older Versions](/older-releases.html)
- [Talks and Slideshows](/talksAndVideos.html)
- [Community ](#storm-apache-org-releases-2-8-3-distributed-rpc--)
  - [Contributing](/contribute/Contributing-to-Storm.html)
  - [People](/contribute/People.html)
  - [ByLaws](/contribute/BYLAWS.html)
  - [PoweredBy](/Powered-By.html)
...
![Tasks in a topology](storm.apache.org/releases/2.8.3/images/drpc-workflow.png)
...
[](#storm-apache-org-releases-2-8-3-distributed-rpc--)

---

<a id="storm-apache-org-releases-2-8-3-eventlogging"></a>
...
- [Security](/security-model.html)
- [Project Information](/about/integrates.html)
- [Documentation ](#storm-apache-org-releases-2-8-3-eventlogging--)
  - [2.8.7](/releases/2.8.7/index.html)
  - [2.8.6](/releases/2.8.6/index.html)
  - [2.8.5](/releases/2.8.5/index.html)
  - [Older Versions](/older-releases.html)
- [Talks and Slideshows](/talksAndVideos.html)
- [Community ](#storm-apache-org-releases-2-8-3-eventlogging--)
  - [Contributing](/contribute/Contributing-to-Storm.html)
  - [People](/contribute/People.html)
  - [ByLaws](/contribute/BYLAWS.html)
  - [PoweredBy](/Powered-By.html)
...
the [Configuration](#storm-apache-org-releases-2-8-3-eventlogging--config) section for more details.
...
![](storm.apache.org/releases/2.8.3/images/enable-event-logging-topology.png "Enable Eventlogging")
...
![](storm.apache.org/releases/2.8.3/images/enable-event-logging-spout.png "Enable Eventlogging at component level")
...
![](storm.apache.org/releases/2.8.3/images/event-logs-view.png "Viewing logged tuples")
...
![](storm.apache.org/releases/2.8.3/images/disable-event-logging-topology.png "Disable Eventlogging at topology level")

Figure 4: Disable event logging at topology level.

## <a id="storm-apache-org-releases-2-8-3-eventlogging--config"></a>Configuration
...
When you implement your own event logger, `arguments` is passed to Map when [IEventLogger#prepare](javadocs/org/apache/storm/metric/IEventLogger.html#prepare-java.util.Map-java.lang.Map-org.apache.storm.task.TopologyContext-) is called.
...
[](#storm-apache-org-releases-2-8-3-eventlogging--)

---

<a id="storm-apache-org-releases-2-8-3-faq"></a>
...
- [Security](/security-model.html)
- [Project Information](/about/integrates.html)
- [Documentation ](#storm-apache-org-releases-2-8-3-faq--)
  - [2.8.7](/releases/2.8.7/index.html)
  - [2.8.6](/releases/2.8.6/index.html)
  - [2.8.5](/releases/2.8.5/index.html)
  - [Older Versions](/older-releases.html)
- [Talks and Slideshows](/talksAndVideos.html)
- [Community ](#storm-apache-org-releases-2-8-3-faq--)
  - [Contributing](/contribute/Contributing-to-Storm.html)
  - [People](/contribute/People.html)
  - [ByLaws](/contribute/BYLAWS.html)
  - [PoweredBy](/Powered-By.html)
...
[](#storm-apache-org-releases-2-8-3-faq--)

---

<a id="storm-apache-org-releases-2-8-3-generic-resources"></a>
...
- [Security](/security-model.html)
- [Project Information](/about/integrates.html)
- [Documentation ](#storm-apache-org-releases-2-8-3-generic-resources--)
  - [2.8.7](/releases/2.8.7/index.html)
  - [2.8.6](/releases/2.8.6/index.html)
  - [2.8.5](/releases/2.8.5/index.html)
  - [Older Versions](/older-releases.html)
- [Talks and Slideshows](/talksAndVideos.html)
- [Community ](#storm-apache-org-releases-2-8-3-generic-resources--)
  - [Contributing](/contribute/Contributing-to-Storm.html)
  - [People](/contribute/People.html)
  - [ByLaws](/contribute/BYLAWS.html)
  - [PoweredBy](/Powered-By.html)
...
Generic Resources allow Storm to reference arbitrary resource types. Generic Resources may be considered an extension of the resources enumerated by the [Resource Aware Scheduler](#storm-apache-org-releases-2-8-3-resource_aware_scheduler_overview), which accounts for CPU and memory.
...
![Storm Cluster UI](storm.apache.org/releases/2.8.3/images/storm_ui.png)
...
[](#storm-apache-org-releases-2-8-3-generic-resources--)

---

<a id="storm-apache-org-releases-2-8-3-guaranteeing-message-processing"></a>
...
- [Security](/security-model.html)
- [Project Information](/about/integrates.html)
- [Documentation ](#storm-apache-org-releases-2-8-3-guaranteeing-message-processing--)
  - [2.8.7](/releases/2.8.7/index.html)
  - [2.8.6](/releases/2.8.6/index.html)
  - [2.8.5](/releases/2.8.5/index.html)
  - [Older Versions](/older-releases.html)
- [Talks and Slideshows](/talksAndVideos.html)
- [Community ](#storm-apache-org-releases-2-8-3-guaranteeing-message-processing--)
  - [Contributing](/contribute/Contributing-to-Storm.html)
  - [People](/contribute/People.html)
  - [ByLaws](/contribute/BYLAWS.html)
  - [PoweredBy](/Powered-By.html)
...
Storm offers several different levels of guaranteed message processing, including best effort, at least once, and exactly once through [Trident](#storm-apache-org-releases-2-8-3-trident-tutorial).
...
![Tuple DAG](storm.apache.org/releases/2.8.3/images/tuple-dag.png)
...
As always in software design, the answer is "it depends." If you really want exactly once semantics use the [Trident](#storm-apache-org-releases-2-8-3-trident-tutorial) API. In some cases, like with a lot of analytics, dropping data is OK so disabling the fault tolerance by setting the number of acker bolts to 0 [Config.TOPOLOGY\_ACKERS](javadocs/org/apache/storm/Config.html#TOPOLOGY_ACKERS). But in some cases you want to be sure that everything was processed at least once and nothing was dropped. This is especially useful if all operations are idenpotent or if deduping can happen aferwards.

### How does Storm implement reliability in an efficient way?

A Storm topology has a set of special "acker" tasks that track the DAG of tuples for every spout tuple. When an acker sees that a DAG is complete, it sends a message to the spout task that created the spout tuple to ack the message. You can set the number of acker tasks for a topology in the topology configuration using [Config.TOPOLOGY\_ACKERS](javadocs/org/apache/storm/Config.html#TOPOLOGY_ACKERS). Storm defaults TOPOLOGY\_ACKERS to one task per worker.
...
![What happens on an ack](storm.apache.org/releases/2.8.3/images/ack_tree.png)
...
[](#storm-apache-org-releases-2-8-3-guaranteeing-message-processing--)

---

<a id="storm-apache-org-releases-2-8-3-hooks"></a>
...
- [Security](/security-model.html)
- [Project Information](/about/integrates.html)
- [Documentation ](#storm-apache-org-releases-2-8-3-hooks--)
  - [2.8.7](/releases/2.8.7/index.html)
  - [2.8.6](/releases/2.8.6/index.html)
  - [2.8.5](/releases/2.8.5/index.html)
  - [Older Versions](/older-releases.html)
- [Talks and Slideshows](/talksAndVideos.html)
- [Community ](#storm-apache-org-releases-2-8-3-hooks--)
  - [Contributing](/contribute/Contributing-to-Storm.html)
  - [People](/contribute/People.html)
  - [ByLaws](/contribute/BYLAWS.html)
  - [PoweredBy](/Powered-By.html)
...
[](#storm-apache-org-releases-2-8-3-hooks--)

---

<a id="storm-apache-org-releases-2-8-3-implementation-docs"></a>
...
- [Security](/security-model.html)
- [Project Information](/about/integrates.html)
- [Documentation ](#storm-apache-org-releases-2-8-3-implementation-docs--)
  - [2.8.7](/releases/2.8.7/index.html)
  - [2.8.6](/releases/2.8.6/index.html)
  - [2.8.5](/releases/2.8.5/index.html)
  - [Older Versions](/older-releases.html)
- [Talks and Slideshows](/talksAndVideos.html)
- [Community ](#storm-apache-org-releases-2-8-3-implementation-docs--)
  - [Contributing](/contribute/Contributing-to-Storm.html)
  - [People](/contribute/People.html)
  - [ByLaws](/contribute/BYLAWS.html)
  - [PoweredBy](/Powered-By.html)
...
- [Structure of the codebase](#storm-apache-org-releases-2-8-3-structure-of-the-codebase)
- [Lifecycle of a topology](#storm-apache-org-releases-2-8-3-lifecycle-of-a-topology)
- [Message passing implementation](#storm-apache-org-releases-2-8-3-message-passing-implementation)
- [Acking framework implementation](#storm-apache-org-releases-2-8-3-acking-framework-implementation)
- [Metrics](#storm-apache-org-releases-2-8-3-metrics)
- [Nimbus HA](#storm-apache-org-releases-2-8-3-nimbus-ha-design)
...
[](#storm-apache-org-releases-2-8-3-implementation-docs--)

---

<a id="storm-apache-org-releases-2-8-3-joins"></a>
...
- [Security](/security-model.html)
- [Project Information](/about/integrates.html)
- [Documentation ](#storm-apache-org-releases-2-8-3-joins--)
  - [2.8.7](/releases/2.8.7/index.html)
  - [2.8.6](/releases/2.8.6/index.html)
  - [2.8.5](/releases/2.8.5/index.html)
  - [Older Versions](/older-releases.html)
- [Talks and Slideshows](/talksAndVideos.html)
- [Community ](#storm-apache-org-releases-2-8-3-joins--)
  - [Contributing](/contribute/Contributing-to-Storm.html)
  - [People](/contribute/People.html)
  - [ByLaws](/contribute/BYLAWS.html)
  - [PoweredBy](/Powered-By.html)
...
[](#storm-apache-org-releases-2-8-3-joins--)

---

<a id="storm-apache-org-releases-2-8-3-local-mode"></a>
...
- [Security](/security-model.html)
- [Project Information](/about/integrates.html)
- [Documentation ](#storm-apache-org-releases-2-8-3-local-mode--)
  - [2.8.7](/releases/2.8.7/index.html)
  - [2.8.6](/releases/2.8.6/index.html)
  - [2.8.5](/releases/2.8.5/index.html)
  - [Older Versions](/older-releases.html)
- [Talks and Slideshows](/talksAndVideos.html)
- [Community ](#storm-apache-org-releases-2-8-3-local-mode--)
  - [Contributing](/contribute/Contributing-to-Storm.html)
  - [People](/contribute/People.html)
  - [ByLaws](/contribute/BYLAWS.html)
  - [PoweredBy](/Powered-By.html)
...
Local mode simulates a Storm cluster in process and is useful for developing and testing topologies. Running topologies in local mode is similar to running topologies [on a cluster](#storm-apache-org-releases-2-8-3-running-topologies-on-a-production-cluster).
...
[](#storm-apache-org-releases-2-8-3-local-mode--)

---

<a id="storm-apache-org-releases-2-8-3-logs"></a>
...
- [Security](/security-model.html)
- [Project Information](/about/integrates.html)
- [Documentation ](#storm-apache-org-releases-2-8-3-logs--)
  - [2.8.7](/releases/2.8.7/index.html)
  - [2.8.6](/releases/2.8.6/index.html)
  - [2.8.5](/releases/2.8.5/index.html)
  - [Older Versions](/older-releases.html)
- [Talks and Slideshows](/talksAndVideos.html)
- [Community ](#storm-apache-org-releases-2-8-3-logs--)
  - [Contributing](/contribute/Contributing-to-Storm.html)
  - [People](/contribute/People.html)
  - [ByLaws](/contribute/BYLAWS.html)
  - [PoweredBy](/Powered-By.html)
...
![Search in a log](storm.apache.org/releases/2.8.3/images/search-for-a-single-worker-log.png "Search in a log")
...
![Search in a topology](storm.apache.org/releases/2.8.3/images/search-a-topology.png "Search in a topology")
...
[](#storm-apache-org-releases-2-8-3-logs--)

---

<a id="storm-apache-org-releases-2-8-3-maven"></a>
...
- [Security](/security-model.html)
- [Project Information](/about/integrates.html)
- [Documentation ](#storm-apache-org-releases-2-8-3-maven--)
  - [2.8.7](/releases/2.8.7/index.html)
  - [2.8.6](/releases/2.8.6/index.html)
  - [2.8.5](/releases/2.8.5/index.html)
  - [Older Versions](/older-releases.html)
- [Talks and Slideshows](/talksAndVideos.html)
- [Community ](#storm-apache-org-releases-2-8-3-maven--)
  - [Contributing](/contribute/Contributing-to-Storm.html)
  - [People](/contribute/People.html)
  - [ByLaws](/contribute/BYLAWS.html)
  - [PoweredBy](/Powered-By.html)
...
[](#storm-apache-org-releases-2-8-3-maven--)

---

<a id="storm-apache-org-releases-2-8-3-metrics"></a>
...
- [Security](/security-model.html)
- [Project Information](/about/integrates.html)
- [Documentation ](#storm-apache-org-releases-2-8-3-metrics--)
  - [2.8.7](/releases/2.8.7/index.html)
  - [2.8.6](/releases/2.8.6/index.html)
  - [2.8.5](/releases/2.8.5/index.html)
  - [Older Versions](/older-releases.html)
- [Talks and Slideshows](/talksAndVideos.html)
- [Community ](#storm-apache-org-releases-2-8-3-metrics--)
  - [Contributing](/contribute/Contributing-to-Storm.html)
  - [People](/contribute/People.html)
  - [ByLaws](/contribute/BYLAWS.html)
  - [PoweredBy](/Powered-By.html)
...
If you are looking for cluster wide monitoring please see [Cluster Metrics](#storm-apache-org-releases-2-8-3-clustermetrics).
...
Be aware that even though `getValueAndReset` can return an object returning any object makes it very difficult for an `IMetricsConsumer` to know how to translate it into something usable. Also note that because it is sent to the `IMetricsConsumer` as a part of a tuple the values returned need to be able to be [serialized](#storm-apache-org-releases-2-8-3-serialization) by your topology.
...
[](#storm-apache-org-releases-2-8-3-metrics--)

---

<a id="storm-apache-org-releases-2-8-3-multilang-protocol"></a>
...
- [Security](/security-model.html)
- [Project Information](/about/integrates.html)
- [Documentation ](#storm-apache-org-releases-2-8-3-multilang-protocol--)
  - [2.8.7](/releases/2.8.7/index.html)
  - [2.8.6](/releases/2.8.6/index.html)
  - [2.8.5](/releases/2.8.5/index.html)
  - [Older Versions](/older-releases.html)
- [Talks and Slideshows](/talksAndVideos.html)
- [Community ](#storm-apache-org-releases-2-8-3-multilang-protocol--)
  - [Contributing](/contribute/Contributing-to-Storm.html)
  - [People](/contribute/People.html)
  - [ByLaws](/contribute/BYLAWS.html)
  - [PoweredBy](/Powered-By.html)
...
See the docs on the [Blob Store](#storm-apache-org-releases-2-8-3-distcache-blobstore) for more details on how to ship a jar.
...
You can learn more about this on [Concepts](#storm-apache-org-releases-2-8-3-concepts)
...
[](#storm-apache-org-releases-2-8-3-multilang-protocol--)

---

<a id="storm-apache-org-releases-2-8-3-pacemaker"></a>
...
- [Security](/security-model.html)
- [Project Information](/about/integrates.html)
- [Documentation ](#storm-apache-org-releases-2-8-3-pacemaker--)
  - [2.8.7](/releases/2.8.7/index.html)
  - [2.8.6](/releases/2.8.6/index.html)
  - [2.8.5](/releases/2.8.5/index.html)
  - [Older Versions](/older-releases.html)
- [Talks and Slideshows](/talksAndVideos.html)
- [Community ](#storm-apache-org-releases-2-8-3-pacemaker--)
  - [Contributing](/contribute/Contributing-to-Storm.html)
  - [People](/contribute/People.html)
  - [ByLaws](/contribute/BYLAWS.html)
  - [PoweredBy](/Powered-By.html)
...
[](#storm-apache-org-releases-2-8-3-pacemaker--)

---

<a id="storm-apache-org-releases-2-8-3-resource_aware_scheduler_overview"></a>
...
- [Security](/security-model.html)
- [Project Information](/about/integrates.html)
- [Documentation ](#storm-apache-org-releases-2-8-3-resource_aware_scheduler_overview--)
  - [2.8.7](/releases/2.8.7/index.html)
  - [2.8.6](/releases/2.8.6/index.html)
  - [2.8.5](/releases/2.8.5/index.html)
  - [Older Versions](/older-releases.html)
- [Talks and Slideshows](/talksAndVideos.html)
- [Community ](#storm-apache-org-releases-2-8-3-resource_aware_scheduler_overview--)
  - [Contributing](/contribute/Contributing-to-Storm.html)
  - [People](/contribute/People.html)
  - [ByLaws](/contribute/BYLAWS.html)
  - [PoweredBy](/Powered-By.html)
...
1. [Using Resource Aware Scheduler](#storm-apache-org-releases-2-8-3-resource_aware_scheduler_overview--Using-Resource-Aware-Scheduler)
2. [API Overview](#storm-apache-org-releases-2-8-3-resource_aware_scheduler_overview--API-Overview)
   1. [Setting Memory Requirement](#storm-apache-org-releases-2-8-3-resource_aware_scheduler_overview--Setting-Memory-Requirement)
   2. [Shared Memory Requirement](#storm-apache-org-releases-2-8-3-resource_aware_scheduler_overview--Setting-Shared-Memory)
   3. [Setting CPU Requirement](#storm-apache-org-releases-2-8-3-resource_aware_scheduler_overview--Setting-CPU-Requirement)
   4. [Limiting the Heap Size per Worker (JVM) Process](#storm-apache-org-releases-2-8-3-resource_aware_scheduler_overview--Limiting-the-Heap-Size-per-Worker-(JVM)Process)
   5. [Setting Available Resources on Node](#storm-apache-org-releases-2-8-3-resource_aware_scheduler_overview--Setting-Available-Resources-on-Node)
   6. [Other Configurations](#storm-apache-org-releases-2-8-3-resource_aware_scheduler_overview--Other-Configurations)
3. [Topology Priorities and Per User Resource](#storm-apache-org-releases-2-8-3-resource_aware_scheduler_overview--Topology-Priorities-and-Per-User-Resource)
   1. [Setup](#storm-apache-org-releases-2-8-3-resource_aware_scheduler_overview--Setup)
   2. [Specifying Topology Priority](#storm-apache-org-releases-2-8-3-resource_aware_scheduler_overview--Specifying-Topology-Priority)
   3. [Specifying Scheduling Strategy](#storm-apache-org-releases-2-8-3-resource_aware_scheduler_overview--Specifying-Scheduling-Strategy)
   4. [Specifying Topology Prioritization Strategy](#storm-apache-org-releases-2-8-3-resource_aware_scheduler_overview--Specifying-Topology-Prioritization-Strategy)
4. [Profiling Resource Usage](#storm-apache-org-releases-2-8-3-resource_aware_scheduler_overview--Profiling-Resource-Usage)
5. [Enhancements on original DefaultResourceAwareStrategy](#storm-apache-org-releases-2-8-3-resource_aware_scheduler_overview--Enhancements-on-original-DefaultResourceAwareStrategy)
...
For use with Trident, please see the [Trident RAS API](#storm-apache-org-releases-2-8-3-trident-ras-api)
...
[](#storm-apache-org-releases-2-8-3-resource_aware_scheduler_overview--)

---

<a id="storm-apache-org-releases-2-8-3-running-topologies-on-a-production-cluster"></a>
...
- [Security](/security-model.html)
- [Project Information](/about/integrates.html)
- [Documentation ](#storm-apache-org-releases-2-8-3-running-topologies-on-a-production-cluster--)
  - [2.8.7](/releases/2.8.7/index.html)
  - [2.8.6](/releases/2.8.6/index.html)
  - [2.8.5](/releases/2.8.5/index.html)
  - [Older Versions](/older-releases.html)
- [Talks and Slideshows](/talksAndVideos.html)
- [Community ](#storm-apache-org-releases-2-8-3-running-topologies-on-a-production-cluster--)
  - [Contributing](/contribute/Contributing-to-Storm.html)
  - [People](/contribute/People.html)
  - [ByLaws](/contribute/BYLAWS.html)
  - [PoweredBy](/Powered-By.html)
...
Running topologies on a production cluster is similar to running in [Local mode](#storm-apache-org-releases-2-8-3-local-mode). Here are the steps:
...
3) Create a JAR containing your topology code. You have the option to either bundle all of the dependencies of your code into that JAR (except for Storm -- the Storm JARs will be added to the classpath on the worker nodes), or you can leverage the [Classpath handling](#storm-apache-org-releases-2-8-3-classpath-handling) features in Storm for using external libraries without bundling them into your topology JAR.
...
You can find out how to configure your `storm` client to talk to a Storm cluster on [Setting up development environment](#storm-apache-org-releases-2-8-3-setting-up-development-environment).
...
[](#storm-apache-org-releases-2-8-3-running-topologies-on-a-production-cluster--)

---

<a id="storm-apache-org-releases-2-8-3-security"></a>
...
- [Security](/security-model.html)
- [Project Information](/about/integrates.html)
- [Documentation ](#storm-apache-org-releases-2-8-3-security--)
  - [2.8.7](/releases/2.8.7/index.html)
  - [2.8.6](/releases/2.8.6/index.html)
  - [2.8.5](/releases/2.8.5/index.html)
  - [Older Versions](/older-releases.html)
- [Talks and Slideshows](/talksAndVideos.html)
- [Community ](#storm-apache-org-releases-2-8-3-security--)
  - [Contributing](/contribute/Contributing-to-Storm.html)
  - [People](/contribute/People.html)
  - [ByLaws](/contribute/BYLAWS.html)
  - [PoweredBy](/Powered-By.html)
...
Ex:
curl -i --negotiate -u:anyUser -b ~/cookiejar.txt -c ~/cookiejar.txt [http://storm-ui-hostname:8080/api/v1/cluster/summary](http://storm-ui-hostname:8080/api/v1/cluster/summary)

1. Firefox: Goto about:config and search for network.negotiate-auth.trusted-uris double-click to add value "[http://storm-ui-hostname:8080](http://storm-ui-hostname:8080)"
...
[](#storm-apache-org-releases-2-8-3-security--)

---

<a id="storm-apache-org-releases-2-8-3-storm-ui-rest-api"></a>
...
- [Security](/security-model.html)
- [Project Information](/about/integrates.html)
- [Documentation ](#storm-apache-org-releases-2-8-3-storm-ui-rest-api--)
  - [2.8.7](/releases/2.8.7/index.html)
  - [2.8.6](/releases/2.8.6/index.html)
  - [2.8.5](/releases/2.8.5/index.html)
  - [Older Versions](/older-releases.html)
- [Talks and Slideshows](/talksAndVideos.html)
- [Community ](#storm-apache-org-releases-2-8-3-storm-ui-rest-api--)
  - [Contributing](/contribute/Contributing-to-Storm.html)
  - [People](/contribute/People.html)
  - [ByLaws](/contribute/BYLAWS.html)
  - [PoweredBy](/Powered-By.html)
...
If DRPC is configured with either an http or https port it will expose a REST endpoint. (See [Setting up a Storm cluster](#storm-apache-org-releases-2-8-3-setting-up-a-storm-cluster) for how to do that)
...
[](#storm-apache-org-releases-2-8-3-storm-ui-rest-api--)

---

<a id="storm-apache-org-releases-2-8-3-serialization"></a>
...
- [Security](/security-model.html)
- [Project Information](/about/integrates.html)
- [Documentation ](#storm-apache-org-releases-2-8-3-serialization--)
  - [2.8.7](/releases/2.8.7/index.html)
  - [2.8.6](/releases/2.8.6/index.html)
  - [2.8.5](/releases/2.8.5/index.html)
  - [Older Versions](/older-releases.html)
- [Talks and Slideshows](/talksAndVideos.html)
- [Community ](#storm-apache-org-releases-2-8-3-serialization--)
  - [Contributing](/contribute/Contributing-to-Storm.html)
  - [People](/contribute/People.html)
  - [ByLaws](/contribute/BYLAWS.html)
  - [PoweredBy](/Powered-By.html)
...
This page is about how the serialization system in Storm works for versions 0.6.0 and onwards. Storm used a different serialization system prior to 0.6.0 which is documented on [Serialization (prior to 0.6.0)](#storm-apache-org-releases-2-8-3-serialization-prior-to-0-6-0).
...
Storm 0.7.0 lets you set component-specific configurations (read more about this at [Configuration](#storm-apache-org-releases-2-8-3-configuration)). Of course, if one component defines a serialization that serialization will need to be available to other bolts -- otherwise they won't be able to receive messages from that component!
...
[](#storm-apache-org-releases-2-8-3-serialization--)

---

<a id="storm-apache-org-releases-2-8-3-setting-up-a-storm-cluster"></a>
...
- [Security](/security-model.html)
- [Project Information](/about/integrates.html)
- [Documentation ](#storm-apache-org-releases-2-8-3-setting-up-a-storm-cluster--)
  - [2.8.7](/releases/2.8.7/index.html)
  - [2.8.6](/releases/2.8.6/index.html)
  - [2.8.5](/releases/2.8.5/index.html)
  - [Older Versions](/older-releases.html)
- [Talks and Slideshows](/talksAndVideos.html)
- [Community ](#storm-apache-org-releases-2-8-3-setting-up-a-storm-cluster--)
  - [Contributing](/contribute/Contributing-to-Storm.html)
  - [People](/contribute/People.html)
  - [ByLaws](/contribute/BYLAWS.html)
  - [PoweredBy](/Powered-By.html)
...
If you run into difficulties with your Storm cluster, first check for a solution is in the [Troubleshooting](#storm-apache-org-releases-2-8-3-troubleshooting) page. Otherwise, email the mailing list.
...
DRPC optionally offers a REST API as well. To enable this set teh config `drpc.http.port` to the port you want to run on before launching the DRPC server. See the [REST documentation](#storm-apache-org-releases-2-8-3-storm-ui-rest-api) for more information on how to use it.
...
[](#storm-apache-org-releases-2-8-3-setting-up-a-storm-cluster--)

---

<a id="storm-apache-org-releases-2-8-3-state-checkpointing"></a>
...
- [Security](/security-model.html)
- [Project Information](/about/integrates.html)
- [Documentation ](#storm-apache-org-releases-2-8-3-state-checkpointing--)
  - [2.8.7](/releases/2.8.7/index.html)
  - [2.8.6](/releases/2.8.6/index.html)
  - [2.8.5](/releases/2.8.5/index.html)
  - [Older Versions](/older-releases.html)
- [Talks and Slideshows](/talksAndVideos.html)
- [Community ](#storm-apache-org-releases-2-8-3-state-checkpointing--)
  - [Contributing](/contribute/Contributing-to-Storm.html)
  - [People](/contribute/People.html)
  - [ByLaws](/contribute/BYLAWS.html)
  - [PoweredBy](/Powered-By.html)
...
[](#storm-apache-org-releases-2-8-3-state-checkpointing--)

---

<a id="storm-apache-org-releases-2-8-3-storm-scheduler"></a>
...
- [Security](/security-model.html)
- [Project Information](/about/integrates.html)
- [Documentation ](#storm-apache-org-releases-2-8-3-storm-scheduler--)
  - [2.8.7](/releases/2.8.7/index.html)
  - [2.8.6](/releases/2.8.6/index.html)
  - [2.8.5](/releases/2.8.5/index.html)
  - [Older Versions](/older-releases.html)
- [Talks and Slideshows](/talksAndVideos.html)
- [Community ](#storm-apache-org-releases-2-8-3-storm-scheduler--)
  - [Contributing](/contribute/Contributing-to-Storm.html)
  - [People](/contribute/People.html)
  - [ByLaws](/contribute/BYLAWS.html)
  - [PoweredBy](/Powered-By.html)
...
[](#storm-apache-org-releases-2-8-3-storm-scheduler--)

---

<a id="storm-apache-org-releases-2-8-3-stream-api"></a>
...
- [Security](/security-model.html)
- [Project Information](/about/integrates.html)
- [Documentation ](#storm-apache-org-releases-2-8-3-stream-api--)
  - [2.8.7](/releases/2.8.7/index.html)
  - [2.8.6](/releases/2.8.6/index.html)
  - [2.8.5](/releases/2.8.5/index.html)
  - [Older Versions](/older-releases.html)
- [Talks and Slideshows](/talksAndVideos.html)
- [Community ](#storm-apache-org-releases-2-8-3-stream-api--)
  - [Contributing](/contribute/Contributing-to-Storm.html)
  - [People](/contribute/People.html)
  - [ByLaws](/contribute/BYLAWS.html)
  - [PoweredBy](/Powered-By.html)
...
- [Concepts](#storm-apache-org-releases-2-8-3-stream-api--concepts)
  - [Stream Builder](#storm-apache-org-releases-2-8-3-stream-api--streambuilder)
  - [Value mapper](#storm-apache-org-releases-2-8-3-stream-api--valuemapper)
- [Stream APIs](#storm-apache-org-releases-2-8-3-stream-api--streamapis)
  - [Basic transformations](#storm-apache-org-releases-2-8-3-stream-api--basictransformations)
    - [filter](#storm-apache-org-releases-2-8-3-stream-api--filter)
    - [map](#storm-apache-org-releases-2-8-3-stream-api--map)
    - [flatmap](#storm-apache-org-releases-2-8-3-stream-api--flatmap)
  - [Windowing](#storm-apache-org-releases-2-8-3-stream-api--windowing)
  - [Transformation to key-value pairs](#storm-apache-org-releases-2-8-3-stream-api--keyvaluepairs)
    - [mapToPair](#storm-apache-org-releases-2-8-3-stream-api--mapflatmaptopair)
    - [flatMapToPair](#storm-apache-org-releases-2-8-3-stream-api--mapflatmaptopair)
  - [Aggregations](#storm-apache-org-releases-2-8-3-stream-api--aggregations)
    - [aggregate](#storm-apache-org-releases-2-8-3-stream-api--aggregatereduce)
    - [reduce](#storm-apache-org-releases-2-8-3-stream-api--aggregatereduce)
    - [aggregateByKey](#storm-apache-org-releases-2-8-3-stream-api--aggregatereducebykey)
    - [reduceByKey](#storm-apache-org-releases-2-8-3-stream-api--aggregatereducebykey)
    - [groupByKey](#storm-apache-org-releases-2-8-3-stream-api--groupbykey)
    - [countByKey](#storm-apache-org-releases-2-8-3-stream-api--countbykey)
  - [Repartition](#storm-apache-org-releases-2-8-3-stream-api--repartition)
  - [Output operations](#storm-apache-org-releases-2-8-3-stream-api--outputoperations)
    - [print](#storm-apache-org-releases-2-8-3-stream-api--print)
    - [peek](#storm-apache-org-releases-2-8-3-stream-api--peek)
    - [forEach](#storm-apache-org-releases-2-8-3-stream-api--foreach)
    - [to](#storm-apache-org-releases-2-8-3-stream-api--to)
  - [Branch](#storm-apache-org-releases-2-8-3-stream-api--branching)
  - [Joins](#storm-apache-org-releases-2-8-3-stream-api--joins)
  - [CoGroupByKey](#storm-apache-org-releases-2-8-3-stream-api--cogroupbykey)
  - [State](#storm-apache-org-releases-2-8-3-stream-api--state)
    - [updateStateByKey](#storm-apache-org-releases-2-8-3-stream-api--updatestatebykey)
    - [stateQuery](#storm-apache-org-releases-2-8-3-stream-api--statequery)
- [Guarantees](#storm-apache-org-releases-2-8-3-stream-api--guarantees)
- [Example](#storm-apache-org-releases-2-8-3-stream-api--example)
...
# <a id="storm-apache-org-releases-2-8-3-stream-api--concepts"></a> Concepts
...
## <a id="storm-apache-org-releases-2-8-3-stream-api--streambuilder"></a> Stream Builder
...
## <a id="storm-apache-org-releases-2-8-3-stream-api--valuemapper"></a> Value mapper
...
# <a id="storm-apache-org-releases-2-8-3-stream-api--streamapis"></a> Stream APIs
...
## <a id="storm-apache-org-releases-2-8-3-stream-api--basictransformations"></a> Basic transformations

### <a id="storm-apache-org-releases-2-8-3-stream-api--filter"></a> filter
...
### <a id="storm-apache-org-releases-2-8-3-stream-api--map"></a> map
...
### <a id="storm-apache-org-releases-2-8-3-stream-api--flatmap"></a> flatMap
...
## <a id="storm-apache-org-releases-2-8-3-stream-api--windowing"></a> Windowing
...
## <a id="storm-apache-org-releases-2-8-3-stream-api--keyvaluepairs"></a> Transformation to key-value pairs

### <a id="storm-apache-org-releases-2-8-3-stream-api--mapflatmaptopair"></a> mapToPair and flatMapToPair
...
## <a id="storm-apache-org-releases-2-8-3-stream-api--aggregations"></a> Aggregations
...
### <a id="storm-apache-org-releases-2-8-3-stream-api--aggregatereduce"></a> aggregate and reduce
...
### <a id="storm-apache-org-releases-2-8-3-stream-api--aggregatereducebykey"></a> aggregateByKey and reduceByKey
...
### <a id="storm-apache-org-releases-2-8-3-stream-api--groupbykey"></a> groupByKey
...
### <a id="storm-apache-org-releases-2-8-3-stream-api--countbykey"></a> countByKey
...
## <a id="storm-apache-org-releases-2-8-3-stream-api--repartition"></a> Repartition
...
## <a id="storm-apache-org-releases-2-8-3-stream-api--outputoperations"></a> Output operations
...
### <a id="storm-apache-org-releases-2-8-3-stream-api--print"></a> print
...
### <a id="storm-apache-org-releases-2-8-3-stream-api--peek"></a> peek
...
### <a id="storm-apache-org-releases-2-8-3-stream-api--foreach"></a> forEach
...
### <a id="storm-apache-org-releases-2-8-3-stream-api--to"></a> to
...
## <a id="storm-apache-org-releases-2-8-3-stream-api--branching"></a> Branch
...
## <a id="storm-apache-org-releases-2-8-3-stream-api--joins"></a> Joins
...
## <a id="storm-apache-org-releases-2-8-3-stream-api--cogroupbykey"></a> CoGroupByKey
...
## <a id="storm-apache-org-releases-2-8-3-stream-api--state"></a> State

Storm provides APIs for applications to save and update the state of its computation and also to query the state.

### <a id="storm-apache-org-releases-2-8-3-stream-api--updatestatebykey"></a> updateStateByKey
...
### <a id="storm-apache-org-releases-2-8-3-stream-api--statequery"></a> stateQuery
...
# <a id="storm-apache-org-releases-2-8-3-stream-api--guarantees"></a> Guarantees
...
# <a id="storm-apache-org-releases-2-8-3-stream-api--example"></a> Example
...
[](#storm-apache-org-releases-2-8-3-stream-api--)

---

<a id="storm-apache-org-releases-2-8-3-trident-api-overview"></a>
...
- [Security](/security-model.html)
- [Project Information](/about/integrates.html)
- [Documentation ](#storm-apache-org-releases-2-8-3-trident-api-overview--)
  - [2.8.7](/releases/2.8.7/index.html)
  - [2.8.6](/releases/2.8.6/index.html)
  - [2.8.5](/releases/2.8.5/index.html)
  - [Older Versions](/older-releases.html)
- [Talks and Slideshows](/talksAndVideos.html)
- [Community ](#storm-apache-org-releases-2-8-3-trident-api-overview--)
  - [Contributing](/contribute/Contributing-to-Storm.html)
  - [People](/contribute/People.html)
  - [ByLaws](/contribute/BYLAWS.html)
  - [PoweredBy](/Powered-By.html)
...
Examples of tumbling and sliding windows can be found [here](#storm-apache-org-releases-2-8-3-windowing)
...
CombinerAggregators offer high efficiency when used with the aggregate method instead of partitionAggregate ([see below](#storm-apache-org-releases-2-8-3-trident-api-overview--aggregation-operations)).
...
stateQuery and partitionPersist query and update sources of state, respectively. You can read about how to use them on [Trident state doc](#storm-apache-org-releases-2-8-3-trident-state).
...
You can read more about how to use persistentAggregate in the [Trident state doc](#storm-apache-org-releases-2-8-3-trident-state).
...
[](#storm-apache-org-releases-2-8-3-trident-api-overview--)

---

<a id="storm-apache-org-releases-2-8-3-trident-ras-api"></a>
...
- [Security](/security-model.html)
- [Project Information](/about/integrates.html)
- [Documentation ](#storm-apache-org-releases-2-8-3-trident-ras-api--)
  - [2.8.7](/releases/2.8.7/index.html)
  - [2.8.6](/releases/2.8.6/index.html)
  - [2.8.5](/releases/2.8.5/index.html)
  - [Older Versions](/older-releases.html)
- [Talks and Slideshows](/talksAndVideos.html)
- [Community ](#storm-apache-org-releases-2-8-3-trident-ras-api--)
  - [Contributing](/contribute/Contributing-to-Storm.html)
  - [People](/contribute/People.html)
  - [ByLaws](/contribute/BYLAWS.html)
  - [PoweredBy](/Powered-By.html)
...
In order to avoid duplication and inconsistency in documentation, the purpose and effects of resource setting are not described here, but are instead found in the [Resource Aware Scheduler Overview](#storm-apache-org-releases-2-8-3-resource_aware_scheduler_overview)
...
[](#storm-apache-org-releases-2-8-3-trident-ras-api--)

---

<a id="storm-apache-org-releases-2-8-3-trident-spouts"></a>
...
- [Security](/security-model.html)
- [Project Information](/about/integrates.html)
- [Documentation ](#storm-apache-org-releases-2-8-3-trident-spouts--)
  - [2.8.7](/releases/2.8.7/index.html)
  - [2.8.6](/releases/2.8.6/index.html)
  - [2.8.5](/releases/2.8.5/index.html)
  - [Older Versions](/older-releases.html)
- [Talks and Slideshows](/talksAndVideos.html)
- [Community ](#storm-apache-org-releases-2-8-3-trident-spouts--)
  - [Contributing](/contribute/Contributing-to-Storm.html)
  - [People](/contribute/People.html)
  - [ByLaws](/contribute/BYLAWS.html)
  - [PoweredBy](/Powered-By.html)
...
There is an inextricable link between how you source your data streams and how you update state (e.g. databases) based on those data streams. See [Trident state doc](#storm-apache-org-releases-2-8-3-trident-state) for an explanation of this – understanding this link is imperative for understanding the spout options available.
...
[](#storm-apache-org-releases-2-8-3-trident-spouts--)

---

<a id="storm-apache-org-releases-2-8-3-trident-state"></a>
...
- [Security](/security-model.html)
- [Project Information](/about/integrates.html)
- [Documentation ](#storm-apache-org-releases-2-8-3-trident-state--)
  - [2.8.7](/releases/2.8.7/index.html)
  - [2.8.6](/releases/2.8.6/index.html)
  - [2.8.5](/releases/2.8.5/index.html)
  - [Older Versions](/older-releases.html)
- [Talks and Slideshows](/talksAndVideos.html)
- [Community ](#storm-apache-org-releases-2-8-3-trident-state--)
  - [Contributing](/contribute/Contributing-to-Storm.html)
  - [People](/contribute/People.html)
  - [ByLaws](/contribute/BYLAWS.html)
  - [PoweredBy](/Powered-By.html)
...
1. Tuples are processed as small batches (see [the tutorial](#storm-apache-org-releases-2-8-3-trident-tutorial))
...
![Spouts vs States](storm.apache.org/releases/2.8.3/images/spout-vs-state.png)
...
[](#storm-apache-org-releases-2-8-3-trident-state--)

---

<a id="storm-apache-org-releases-2-8-3-trident-tutorial"></a>
...
- [Security](/security-model.html)
- [Project Information](/about/integrates.html)
- [Documentation ](#storm-apache-org-releases-2-8-3-trident-tutorial--)
  - [2.8.7](/releases/2.8.7/index.html)
  - [2.8.6](/releases/2.8.6/index.html)
  - [2.8.5](/releases/2.8.5/index.html)
  - [Older Versions](/older-releases.html)
- [Talks and Slideshows](/talksAndVideos.html)
- [Community ](#storm-apache-org-releases-2-8-3-trident-tutorial--)
  - [Contributing](/contribute/Contributing-to-Storm.html)
  - [People](/contribute/People.html)
  - [ByLaws](/contribute/BYLAWS.html)
  - [PoweredBy](/Powered-By.html)
...
![Batched stream](storm.apache.org/releases/2.8.3/images/batched-stream.png)
...
Of course, you don't have to do this logic manually in your topologies. This logic is wrapped by the State abstraction and done automatically. Nor is your State object required to implement the transaction id trick: if you don't want to pay the cost of storing the transaction id in the database, you don't have to. In that case the State will have at-least-once-processing semantics in the case of failures (which may be fine for your application). You can read more about how to implement a State and the various fault-tolerance tradeoffs possible [in this doc](#storm-apache-org-releases-2-8-3-trident-state).
...
![Compiling Trident to Storm 1](storm.apache.org/releases/2.8.3/images/trident-to-storm1.png)

It would compile into Storm spouts/bolts like this:

![Compiling Trident to Storm 2](storm.apache.org/releases/2.8.3/images/trident-to-storm2.png)
...
[](#storm-apache-org-releases-2-8-3-trident-tutorial--)

---

<a id="storm-apache-org-releases-2-8-3-troubleshooting"></a>
...
- [Security](/security-model.html)
- [Project Information](/about/integrates.html)
- [Documentation ](#storm-apache-org-releases-2-8-3-troubleshooting--)
  - [2.8.7](/releases/2.8.7/index.html)
  - [2.8.6](/releases/2.8.6/index.html)
  - [2.8.5](/releases/2.8.5/index.html)
  - [Older Versions](/older-releases.html)
- [Talks and Slideshows](/talksAndVideos.html)
- [Community ](#storm-apache-org-releases-2-8-3-troubleshooting--)
  - [Contributing](/contribute/Contributing-to-Storm.html)
  - [People](/contribute/People.html)
  - [ByLaws](/contribute/BYLAWS.html)
  - [PoweredBy](/Powered-By.html)
...
- Alternatively, recompile rocksdb-jni with PORTABLE=1 as mentioned in the [INSTALL.md](https://github.com/facebook/rocksdb/blob/master/INSTALL.md) link in "Compliing from Source" section of [https://github.com/facebook/rocksdb/wiki/RocksJava-Basics](https://github.com/facebook/rocksdb/wiki/RocksJava-Basics).
...
[](#storm-apache-org-releases-2-8-3-troubleshooting--)

---

<a id="storm-apache-org-releases-2-8-3-tutorial"></a>
...
- [Security](/security-model.html)
- [Project Information](/about/integrates.html)
- [Documentation ](#storm-apache-org-releases-2-8-3-tutorial--)
  - [2.8.7](/releases/2.8.7/index.html)
  - [2.8.6](/releases/2.8.6/index.html)
  - [2.8.5](/releases/2.8.5/index.html)
  - [Older Versions](/older-releases.html)
- [Talks and Slideshows](/talksAndVideos.html)
- [Community ](#storm-apache-org-releases-2-8-3-tutorial--)
  - [Contributing](/contribute/Contributing-to-Storm.html)
  - [People](/contribute/People.html)
  - [ByLaws](/contribute/BYLAWS.html)
  - [PoweredBy](/Powered-By.html)
...
This tutorial uses examples from the [storm-starter](https://github.com/apache/storm/blob/v2.8.3/examples/storm-starter) project. It's recommended that you clone the project and follow along with the examples. Read [Setting up a development environment](#storm-apache-org-releases-2-8-3-setting-up-development-environment) and [Creating a new Storm project](#storm-apache-org-releases-2-8-3-creating-a-new-storm-project) to get your machine set up.
...
![Storm cluster](storm.apache.org/releases/2.8.3/images/storm-cluster.png)
...
Since topology definitions are just Thrift structs, and Nimbus is a Thrift service, you can create and submit topologies using any programming language. The above example is the easiest way to do it from a JVM-based language. See [Running topologies on a production cluster](#storm-apache-org-releases-2-8-3-running-topologies-on-a-production-cluster)] for more information on starting and stopping topologies.
...
![A Storm topology](storm.apache.org/releases/2.8.3/images/topology.png)
...
The `cleanup` method is called when a Bolt is being shutdown and should cleanup any resources that were opened. There's no guarantee that this method will be called on the cluster: for example, if the machine the task is running on blows up, there's no way to invoke the method. The `cleanup` method is intended for when you run topologies in [local mode](#storm-apache-org-releases-2-8-3-local-mode) (where a Storm cluster is simulated in a process), and you want to be able to run and kill many topologies without suffering any resource leaks.

The `declareOutputFields` method declares that the `ExclamationBolt` emits 1-tuples with one field called "word".

The `getComponentConfiguration` method allows you to configure various aspects of how this component runs. This is a more advanced topic that is explained further on [Configuration](#storm-apache-org-releases-2-8-3-configuration).
...
Storm has two modes of operation: local mode and distributed mode. In local mode, Storm executes completely in a process by simulating worker nodes with threads. Local mode is useful for testing and development of topologies. You can read more about running topologies in local mode on [Local mode](#storm-apache-org-releases-2-8-3-local-mode).
...
![Tasks in a topology](storm.apache.org/releases/2.8.3/images/topology-tasks.png)
...
There are a few other kinds of stream groupings. You can read more about them on [Concepts](#storm-apache-org-releases-2-8-3-concepts).
...
For more information on writing spouts and bolts in other languages, and to learn about how to create topologies in other languages (and avoid the JVM completely), see [Using non-JVM languages with Storm](#storm-apache-org-releases-2-8-3-using-non-jvm-languages-with-storm).
...
[](#storm-apache-org-releases-2-8-3-tutorial--)

---

<a id="storm-apache-org-releases-2-8-3-understanding-the-parallelism-of-a-storm-topology"></a>
...
- [Security](/security-model.html)
- [Project Information](/about/integrates.html)
- [Documentation ](#storm-apache-org-releases-2-8-3-understanding-the-parallelism-of-a-storm-topology--)
  - [2.8.7](/releases/2.8.7/index.html)
  - [2.8.6](/releases/2.8.6/index.html)
  - [2.8.5](/releases/2.8.5/index.html)
  - [Older Versions](/older-releases.html)
- [Talks and Slideshows](/talksAndVideos.html)
- [Community ](#storm-apache-org-releases-2-8-3-understanding-the-parallelism-of-a-storm-topology--)
  - [Contributing](/contribute/Contributing-to-Storm.html)
  - [People](/contribute/People.html)
  - [ByLaws](/contribute/BYLAWS.html)
  - [PoweredBy](/Powered-By.html)
...
![The relationships of worker processes, executors (threads) and tasks in Storm](storm.apache.org/releases/2.8.3/images/relationships-worker-processes-executors-tasks.png)
...
- Configuration option: [TOPOLOGY\_TASKS](javadocs/org/apache/storm/Config.html#TOPOLOGY_TASKS)
- How to set in your code (examples):
...
![Example of a running topology in Storm](storm.apache.org/releases/2.8.3/images/example-of-a-running-topology.png)
...
- [TOPOLOGY\_MAX\_TASK\_PARALLELISM](javadocs/org/apache/storm/Config.html#TOPOLOGY_MAX_TASK_PARALLELISM): This setting puts a ceiling on the number of executors that can be spawned for a single component. It is typically used during testing to limit the number of threads spawned when running a topology in local mode. You can set this option via e.g. [Config#setMaxTaskParallelism()](javadocs/org/apache/storm/Config.html#setMaxTaskParallelism(int)).
...
[](#storm-apache-org-releases-2-8-3-understanding-the-parallelism-of-a-storm-topology--)

---

<a id="storm-apache-org-releases-2-8-3-using-non-jvm-languages-with-storm"></a>
...
- [Security](/security-model.html)
- [Project Information](/about/integrates.html)
- [Documentation ](#storm-apache-org-releases-2-8-3-using-non-jvm-languages-with-storm--)
  - [2.8.7](/releases/2.8.7/index.html)
  - [2.8.6](/releases/2.8.6/index.html)
  - [2.8.5](/releases/2.8.5/index.html)
  - [Older Versions](/older-releases.html)
- [Talks and Slideshows](/talksAndVideos.html)
- [Community ](#storm-apache-org-releases-2-8-3-using-non-jvm-languages-with-storm--)
  - [Contributing](/contribute/Contributing-to-Storm.html)
  - [People](/contribute/People.html)
  - [ByLaws](/contribute/BYLAWS.html)
  - [PoweredBy](/Powered-By.html)
...
- implementing spouts and bolts in another language is called a "multilang components" or "shelling"
  - Here's a specification of the protocol: [Multilang protocol](#storm-apache-org-releases-2-8-3-multilang-protocol)
...
[](#storm-apache-org-releases-2-8-3-using-non-jvm-languages-with-storm--)

---

<a id="storm-apache-org-releases-2-8-3-windowing"></a>
...
- [Security](/security-model.html)
- [Project Information](/about/integrates.html)
- [Documentation ](#storm-apache-org-releases-2-8-3-windowing--)
  - [2.8.7](/releases/2.8.7/index.html)
  - [2.8.6](/releases/2.8.6/index.html)
  - [2.8.5](/releases/2.8.5/index.html)
  - [Older Versions](/older-releases.html)
- [Talks and Slideshows](/talksAndVideos.html)
- [Community ](#storm-apache-org-releases-2-8-3-windowing--)
  - [Contributing](/contribute/Contributing-to-Storm.html)
  - [People](/contribute/People.html)
  - [ByLaws](/contribute/BYLAWS.html)
  - [PoweredBy](/Powered-By.html)
...
framework for saving the window state. For more details on state checkpointing see [State-checkpointing](#storm-apache-org-releases-2-8-3-state-checkpointing).
...
[](#storm-apache-org-releases-2-8-3-windowing--)

---

<a id="storm-apache-org-releases-2-8-3-cgroups_in_storm"></a>
...
- [Security](/security-model.html)
- [Project Information](/about/integrates.html)
- [Documentation ](#storm-apache-org-releases-2-8-3-cgroups_in_storm--)
  - [2.8.7](/releases/2.8.7/index.html)
  - [2.8.6](/releases/2.8.6/index.html)
  - [2.8.5](/releases/2.8.5/index.html)
  - [Older Versions](/older-releases.html)
- [Talks and Slideshows](/talksAndVideos.html)
- [Community ](#storm-apache-org-releases-2-8-3-cgroups_in_storm--)
  - [Contributing](/contribute/Contributing-to-Storm.html)
  - [People](/contribute/People.html)
  - [ByLaws](/contribute/BYLAWS.html)
  - [PoweredBy](/Powered-By.html)
...
[https://access.redhat.com/documentation/en-US/Red\_Hat\_Enterprise\_Linux/6/html/Resource\_Management\_Guide/ch-Using\_Control\_Groups.html#The\_cgconfig.conf\_File](https://access.redhat.com/documentation/en-US/Red_Hat_Enterprise_Linux/6/html/Resource_Management_Guide/ch-Using_Control_Groups.html#The_cgconfig.conf_File)
...
| storm.resource.isolation.plugin | Select a resource isolation plugin to use whenstorm.resource.isolation.plugin.enableis set to true. Default to "org.apache.storm.container.cgroup.CgroupManager" |
...
[](#storm-apache-org-releases-2-8-3-cgroups_in_storm--)

---

<a id="storm-apache-org-releases-2-8-3-distcache-blobstore"></a>
...
- [Security](/security-model.html)
- [Project Information](/about/integrates.html)
- [Documentation ](#storm-apache-org-releases-2-8-3-distcache-blobstore--)
  - [2.8.7](/releases/2.8.7/index.html)
  - [2.8.6](/releases/2.8.6/index.html)
  - [2.8.5](/releases/2.8.5/index.html)
  - [Older Versions](/older-releases.html)
- [Talks and Slideshows](/talksAndVideos.html)
- [Community ](#storm-apache-org-releases-2-8-3-distcache-blobstore--)
  - [Contributing](/contribute/Contributing-to-Storm.html)
  - [People](/contribute/People.html)
  - [ByLaws](/contribute/BYLAWS.html)
  - [PoweredBy](/Powered-By.html)
...
![LocalFsBlobStore](storm.apache.org/releases/2.8.3/images/local_blobstore.png)
...
![HdfsBlobStore](storm.apache.org/releases/2.8.3/images/hdfs_blobstore.png)
...
![Nimbus High Availability - BlobStore](storm.apache.org/releases/2.8.3/images/nimbus_ha_blobstore.png)
...
[](#storm-apache-org-releases-2-8-3-distcache-blobstore--)

---

<a id="storm-apache-org-releases-2-8-3-dynamic-log-level-settings"></a>
...
- [Security](/security-model.html)
- [Project Information](/about/integrates.html)
- [Documentation ](#storm-apache-org-releases-2-8-3-dynamic-log-level-settings--)
  - [2.8.7](/releases/2.8.7/index.html)
  - [2.8.6](/releases/2.8.6/index.html)
  - [2.8.5](/releases/2.8.5/index.html)
  - [Older Versions](/older-releases.html)
- [Talks and Slideshows](/talksAndVideos.html)
- [Community ](#storm-apache-org-releases-2-8-3-dynamic-log-level-settings--)
  - [Contributing](/contribute/Contributing-to-Storm.html)
  - [People](/contribute/People.html)
  - [ByLaws](/contribute/BYLAWS.html)
  - [PoweredBy](/Powered-By.html)
...
![Change Log Level dialog](storm.apache.org/releases/2.8.3/images/dynamic_log_level_settings_1.png "Change Log Level dialog")
...
![After adding a log level setting](storm.apache.org/releases/2.8.3/images/dynamic_log_level_settings_2.png "After adding a log level setting")
...
[](#storm-apache-org-releases-2-8-3-dynamic-log-level-settings--)

---

<a id="storm-apache-org-releases-2-8-3-dynamic-worker-profiling"></a>
...
- [Security](/security-model.html)
- [Project Information](/about/integrates.html)
- [Documentation ](#storm-apache-org-releases-2-8-3-dynamic-worker-profiling--)
  - [2.8.7](/releases/2.8.7/index.html)
  - [2.8.6](/releases/2.8.6/index.html)
  - [2.8.5](/releases/2.8.5/index.html)
  - [Older Versions](/older-releases.html)
- [Talks and Slideshows](/talksAndVideos.html)
- [Community ](#storm-apache-org-releases-2-8-3-dynamic-worker-profiling--)
  - [Contributing](/contribute/Contributing-to-Storm.html)
  - [People](/contribute/People.html)
  - [ByLaws](/contribute/BYLAWS.html)
  - [PoweredBy](/Powered-By.html)
...
![Selecting Workers](storm.apache.org/releases/2.8.3/images/dynamic_profiling_debugging_4.png "Selecting Workers")
...
![Profiling and Debugging](storm.apache.org/releases/2.8.3/images/dynamic_profiling_debugging_1.png "Profiling and Debugging")

For start jprofile, provide a timeout in minutes (or 10 if not needed). Then click on “Start”.

![After starting jprofile for worker](storm.apache.org/releases/2.8.3/images/dynamic_profiling_debugging_2.png "After jprofile for worker ")
...
![Dump Files Links for worker](storm.apache.org/releases/2.8.3/images/dynamic_profiling_debugging_3.png "Dump Files Links for worker")
...
[](#storm-apache-org-releases-2-8-3-dynamic-worker-profiling--)

---

<a id="storm-apache-org-releases-2-8-3-flux"></a>
...
- [Security](/security-model.html)
- [Project Information](/about/integrates.html)
- [Documentation ](#storm-apache-org-releases-2-8-3-flux--)
  - [2.8.7](/releases/2.8.7/index.html)
  - [2.8.6](/releases/2.8.6/index.html)
  - [2.8.5](/releases/2.8.5/index.html)
  - [Older Versions](/older-releases.html)
- [Talks and Slideshows](/talksAndVideos.html)
- [Community ](#storm-apache-org-releases-2-8-3-flux--)
  - [Contributing](/contribute/Contributing-to-Storm.html)
  - [People](/contribute/People.html)
  - [ByLaws](/contribute/BYLAWS.html)
  - [PoweredBy](/Powered-By.html)
...
For example, [Storm's HDFS module](#storm-apache-org-releases-2-8-3-storm-hdfs) includes the following `enum` definition (simplified for brevity):
...
[](#storm-apache-org-releases-2-8-3-flux--)

---

<a id="storm-apache-org-releases-2-8-3-metrics_v2"></a>
...
- [Security](/security-model.html)
- [Project Information](/about/integrates.html)
- [Documentation ](#storm-apache-org-releases-2-8-3-metrics_v2--)
  - [2.8.7](/releases/2.8.7/index.html)
  - [2.8.6](/releases/2.8.6/index.html)
  - [2.8.5](/releases/2.8.5/index.html)
  - [Older Versions](/older-releases.html)
- [Talks and Slideshows](/talksAndVideos.html)
- [Community ](#storm-apache-org-releases-2-8-3-metrics_v2--)
  - [Contributing](/contribute/Contributing-to-Storm.html)
  - [People](/contribute/People.html)
  - [ByLaws](/contribute/BYLAWS.html)
  - [PoweredBy](/Powered-By.html)
...
3. Starting from storm 2.3, the `daemons` section is removed from `topology.metrics.reporters` (or `storm.metrics.reporters`).
   ...
   For daemon metrics, please refer to [Cluster Metrics](#storm-apache-org-releases-2-8-3-clustermetrics).
...
[](#storm-apache-org-releases-2-8-3-metrics_v2--)

---

<a id="storm-apache-org-releases-2-8-3-storm-hdfs"></a>
...
- [Security](/security-model.html)
- [Project Information](/about/integrates.html)
- [Documentation ](#storm-apache-org-releases-2-8-3-storm-hdfs--)
  - [2.8.7](/releases/2.8.7/index.html)
  - [2.8.6](/releases/2.8.6/index.html)
  - [2.8.5](/releases/2.8.5/index.html)
  - [Older Versions](/older-releases.html)
- [Talks and Slideshows](/talksAndVideos.html)
- [Community ](#storm-apache-org-releases-2-8-3-storm-hdfs--)
  - [Contributing](/contribute/Contributing-to-Storm.html)
  - [People](/contribute/People.html)
  - [ByLaws](/contribute/BYLAWS.html)
  - [PoweredBy](/Powered-By.html)
...
When packaging your topology, it's important that you use the [maven-shade-plugin](#storm-apache-org-releases-2-8-3-storm-hdfs) as opposed to the
[maven-assembly-plugin](#storm-apache-org-releases-2-8-3-storm-hdfs).
...
listed on this link
[http://hadoop.apache.org/docs/current/hadoop-project-dist/hadoop-common/Superusers.html](http://hadoop.apache.org/docs/current/hadoop-project-dist/hadoop-common/Superusers.html)

You can read about setting up secure HDFS here: [http://hadoop.apache.org/docs/current/hadoop-project-dist/hadoop-common/SecureMode.html](http://hadoop.apache.org/docs/current/hadoop-project-dist/hadoop-common/SecureMode.html).
...
| .withOutputFields() |  |  | Sets the names for the output fields for the spout. The number of fields depends upon the reader being used. For convenience, built-in reader types expose a static member calleddefaultFieldsthat can be used for setting this. |
...
| .setHdfsClientSettings() | ~~hdfs.config~~ (unless changed via withConfigKey) |  | Set it to a Map of Key/value pairs indicating the HDFS settings to be used. For example, keytab and principal could be set using this. See sectionUsing keytabs on all worker hostsunder HDFS bolt below. |
...
[](#storm-apache-org-releases-2-8-3-storm-hdfs--)

---

<a id="storm-apache-org-releases-2-8-3-storm-jdbc"></a>
...
- [Security](/security-model.html)
- [Project Information](/about/integrates.html)
- [Documentation ](#storm-apache-org-releases-2-8-3-storm-jdbc--)
  - [2.8.7](/releases/2.8.7/index.html)
  - [2.8.6](/releases/2.8.6/index.html)
  - [2.8.5](/releases/2.8.5/index.html)
  - [Older Versions](/older-releases.html)
- [Talks and Slideshows](/talksAndVideos.html)
- [Community ](#storm-apache-org-releases-2-8-3-storm-jdbc--)
  - [Contributing](/contribute/Contributing-to-Storm.html)
  - [People](/contribute/People.html)
  - [ByLaws](/contribute/BYLAWS.html)
  - [PoweredBy](/Powered-By.html)
...
2. Will use the provided HikariCP configuration to establish a connection pool with specified Database configuration and
   ...
   Please see [https://github.com/brettwooldridge/HikariCP#configuration-knobs-baby](https://github.com/brettwooldridge/HikariCP#configuration-knobs-baby) to learn more about hikari configuration properties.
...
[](#storm-apache-org-releases-2-8-3-storm-jdbc--)

---

<a id="storm-apache-org-releases-2-8-3-storm-jms"></a>
...
- [Security](/security-model.html)
- [Project Information](/about/integrates.html)
- [Documentation ](#storm-apache-org-releases-2-8-3-storm-jms--)
  - [2.8.7](/releases/2.8.7/index.html)
  - [2.8.6](/releases/2.8.6/index.html)
  - [2.8.5](/releases/2.8.5/index.html)
  - [Older Versions](/older-releases.html)
- [Talks and Slideshows](/talksAndVideos.html)
- [Community ](#storm-apache-org-releases-2-8-3-storm-jms--)
  - [Contributing](/contribute/Contributing-to-Storm.html)
  - [People](/contribute/People.html)
  - [ByLaws](/contribute/BYLAWS.html)
  - [PoweredBy](/Powered-By.html)
...
[Example Topology](#storm-apache-org-releases-2-8-3-storm-jms-example)

[Using Spring JMS](#storm-apache-org-releases-2-8-3-storm-jms-spring)
...
[](#storm-apache-org-releases-2-8-3-storm-jms--)

---

<a id="storm-apache-org-releases-2-8-3-storm-kafka-client"></a>
...
- [Security](/security-model.html)
- [Project Information](/about/integrates.html)
- [Documentation ](#storm-apache-org-releases-2-8-3-storm-kafka-client--)
  - [2.8.7](/releases/2.8.7/index.html)
  - [2.8.6](/releases/2.8.6/index.html)
  - [2.8.5](/releases/2.8.5/index.html)
  - [Older Versions](/older-releases.html)
- [Talks and Slideshows](/talksAndVideos.html)
- [Community ](#storm-apache-org-releases-2-8-3-storm-kafka-client--)
  - [Contributing](/contribute/Contributing-to-Storm.html)
  - [People](/contribute/People.html)
  - [ByLaws](/contribute/BYLAWS.html)
  - [PoweredBy](/Powered-By.html)
...
You can provide all the producer properties in your Storm topology by calling `KafkaBolt.withProducerProperties()` and `TridentKafkaStateFactory.withProducerProperties()`. Please see [http://kafka.apache.org/documentation.html#newproducerconfigs](http://kafka.apache.org/documentation.html#newproducerconfigs)
...
you can use the storm-kafka module ([https://github.com/apache/storm/tree/1.x-branch/external/storm-kafka](https://github.com/apache/storm/tree/1.x-branch/external/storm-kafka)).  
...
or enabling backpressure with Config.TOPOLOGY\_MAX\_SPOUT\_PENDING.
...
| --- | --- | --- |
| Setting:startOffsetTimeDefault:EarliestTime________________________________________________Setting:forceFromStartDefault:falsestartOffsetTime&forceFromStarttogether determine the starting offset.forceFromStartdetermines whether the Zookeeper offset is ignored.startOffsetTimesets the timestamp that determines the beginning offset, in case there is no offset in Zookeeper, or the Zookeeper offset is ignored | Setting:FirstPollOffsetStrategyDefault:UNCOMMITTED_EARLIESTRefer to the helper tablefor pickingFirstPollOffsetStrategybased on yourstartOffsetTime&forceFromStartsettings | <KafkaSpoutConfig-Builder>.setFirstPollOffsetStrategy(<strategy-name>) |
| Setting:schemeThe interface that specifies how aByteBufferfrom a Kafka topic is transformed into Storm tupleDefault:RawMultiScheme | Setting:Deserializers | <KafkaSpoutConfig-Builder>.setProp(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, <deserializer-class>)<KafkaSpoutConfig-Builder>.setProp(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, <deserializer-class>) |
| Setting:fetchSizeBytesMessage fetch size -- the number of bytes to attempt to fetch in one request to a Kafka serverDefault:1MB | Setting:max.partition.fetch.bytes | <KafkaSpoutConfig-Builder>.setProp(ConsumerConfig.MAX_PARTITION_FETCH_BYTES_CONFIG, <int-value>) |
| Setting:bufferSizeBytesBuffer size (in bytes) for network requests. The buffer size which consumer has for pulling data from producerDefault:1MB | Setting:receive.buffer.bytes | <KafkaSpoutConfig-Builder>.setProp(ConsumerConfig.RECEIVE_BUFFER_CONFIG, <int-value>) |
| Setting:socketTimeoutMsDefault:10000 | N/A |  |
| Setting:useStartOffsetTimeIfOffsetOutOfRangeDefault:true | Setting:auto.offset.resetDefault:Note that the default value forauto.offset.resetisearliestif you haveProcessingGuaranteeset toAT_LEAST_ONCE, but the default value islatestotherwise. | <KafkaSpoutConfig-Builder>.setProp(ConsumerConfig.AUTO_OFFSET_RESET_CONFIG, <String>) |
| Setting:fetchMaxWaitMaximum time in ms to wait for the responseDefault:10000 | Setting:fetch.max.wait.ms | <KafkaSpoutConfig-Builder>.setProp(ConsumerConfig.FETCH_MAX_WAIT_MS_CONFIG, <value>) |
| Setting:maxOffsetBehindSpecifies how long a spout attempts to retry the processing of a failed tuple. One of the scenarios is when a failing tuple's offset is more thanmaxOffsetBehindbehind the acked offset, the spout stops retrying the tuple.Default:LONG.MAX_VALUE | N/A |  |
| Setting:clientId | Setting:client.id | <KafkaSpoutConfig-Builder>.setProp(ConsumerConfig.CLIENT_ID_CONFIG, <String>) |
...
[](#storm-apache-org-releases-2-8-3-storm-kafka-client--)

---

<a id="storm-apache-org-releases-2-8-3-storm-metricstore"></a>
...
- [Security](/security-model.html)
- [Project Information](/about/integrates.html)
- [Documentation ](#storm-apache-org-releases-2-8-3-storm-metricstore--)
  - [2.8.7](/releases/2.8.7/index.html)
  - [2.8.6](/releases/2.8.6/index.html)
  - [2.8.5](/releases/2.8.5/index.html)
  - [Older Versions](/older-releases.html)
- [Talks and Slideshows](/talksAndVideos.html)
- [Community ](#storm-apache-org-releases-2-8-3-storm-metricstore--)
  - [Contributing](/contribute/Contributing-to-Storm.html)
  - [People](/contribute/People.html)
  - [ByLaws](/contribute/BYLAWS.html)
  - [PoweredBy](/Powered-By.html)
...
([`RocksDbStore`](https://github.com/apache/storm/blob/v2.8.3/storm-server/src/main/java/org/apache/storm/metricstore/rocksdb/RocksDbStore.java)) is using RocksDB,
a key-value store.
...
[](#storm-apache-org-releases-2-8-3-storm-metricstore--)

---

<a id="storm-apache-org-releases-2-8-3-storm-redis"></a>
...
- [Security](/security-model.html)
- [Project Information](/about/integrates.html)
- [Documentation ](#storm-apache-org-releases-2-8-3-storm-redis--)
  - [2.8.7](/releases/2.8.7/index.html)
  - [2.8.6](/releases/2.8.6/index.html)
  - [2.8.5](/releases/2.8.5/index.html)
  - [Older Versions](/older-releases.html)
- [Talks and Slideshows](/talksAndVideos.html)
- [Community ](#storm-apache-org-releases-2-8-3-storm-redis--)
  - [Contributing](/contribute/Contributing-to-Storm.html)
  - [People](/contribute/People.html)
  - [ByLaws](/contribute/BYLAWS.html)
  - [PoweredBy](/Powered-By.html)
...
[](#storm-apache-org-releases-2-8-3-storm-redis--)

---

<a id="storm-apache-org-releases-2-8-3-windows-users-guide"></a>
...
- [Security](/security-model.html)
- [Project Information](/about/integrates.html)
- [Documentation ](#storm-apache-org-releases-2-8-3-windows-users-guide--)
  - [2.8.7](/releases/2.8.7/index.html)
  - [2.8.6](/releases/2.8.6/index.html)
  - [2.8.5](/releases/2.8.5/index.html)
  - [Older Versions](/older-releases.html)
- [Talks and Slideshows](/talksAndVideos.html)
- [Community ](#storm-apache-org-releases-2-8-3-windows-users-guide--)
  - [Contributing](/contribute/Contributing-to-Storm.html)
  - [People](/contribute/People.html)
  - [ByLaws](/contribute/BYLAWS.html)
  - [PoweredBy](/Powered-By.html)
...
[](#storm-apache-org-releases-2-8-3-windows-users-guide--)

---

<a id="storm-apache-org-releases-2-8-3-acking-framework-implementation"></a>
...
- [Security](/security-model.html)
- [Project Information](/about/integrates.html)
- [Documentation ](#storm-apache-org-releases-2-8-3-acking-framework-implementation--)
  - [2.8.7](/releases/2.8.7/index.html)
  - [2.8.6](/releases/2.8.6/index.html)
  - [2.8.5](/releases/2.8.5/index.html)
  - [Older Versions](/older-releases.html)
- [Talks and Slideshows](/talksAndVideos.html)
- [Community ](#storm-apache-org-releases-2-8-3-acking-framework-implementation--)
  - [Contributing](/contribute/Contributing-to-Storm.html)
  - [People](/contribute/People.html)
  - [ByLaws](/contribute/BYLAWS.html)
  - [PoweredBy](/Powered-By.html)
...
You can read a bit more about the [reliability mechanism](#storm-apache-org-releases-2-8-3-guaranteeing-message-processing--what-is-storms-reliability-api) elsewhere on the wiki -- this explains the internal details.
...
[](#storm-apache-org-releases-2-8-3-acking-framework-implementation--)

---

<a id="storm-apache-org-releases-2-8-3-clojure-dsl"></a>
...
- [Security](/security-model.html)
- [Project Information](/about/integrates.html)
- [Documentation ](#storm-apache-org-releases-2-8-3-clojure-dsl--)
  - [2.8.7](/releases/2.8.7/index.html)
  - [2.8.6](/releases/2.8.6/index.html)
  - [2.8.5](/releases/2.8.5/index.html)
  - [Older Versions](/older-releases.html)
- [Talks and Slideshows](/talksAndVideos.html)
- [Community ](#storm-apache-org-releases-2-8-3-clojure-dsl--)
  - [Contributing](/contribute/Contributing-to-Storm.html)
  - [People](/contribute/People.html)
  - [ByLaws](/contribute/BYLAWS.html)
  - [PoweredBy](/Powered-By.html)
...
Let's take a look at an example topology definition [from the storm-starter project](https://github.com/apache/storm/blob/v2.8.3/examples/storm-starter/src/clj/org/apache/storm/starter/clj/word_count.clj):
...
See [Concepts](#storm-apache-org-releases-2-8-3-concepts) for more info on stream groupings. Here's an example input declaration showcasing the various ways to declare inputs:
...
The syntax of output declarations is described in more detail in the `defbolt` section below. See [Using non JVM languages with Storm](#storm-apache-org-releases-2-8-3-using-non-jvm-languages-with-storm) for more details on how multilang works within Storm.
...
The stream id is a string, while the stream spec is either a vector of fields or a vector of fields wrapped by `direct-stream`. `direct stream` marks the stream as a direct stream (See [Concepts](#storm-apache-org-releases-2-8-3-concepts) and [Direct groupings](#storm-apache-org-releases-2-8-3-clojure-dsl) for more details on direct streams).
...
See [Guaranteeing message processing](#storm-apache-org-releases-2-8-3-guaranteeing-message-processing) for more info on acking and anchoring.
...
Here's an example `defspout` implementation from [storm-starter](https://github.com/apache/storm/blob/v2.8.3/examples/storm-starter/src/clj/org/apache/storm/starter/clj/word_count.clj):
...
[](#storm-apache-org-releases-2-8-3-clojure-dsl--)

---

<a id="storm-apache-org-releases-2-8-3-creating-a-new-storm-project"></a>
...
- [Security](/security-model.html)
- [Project Information](/about/integrates.html)
- [Documentation ](#storm-apache-org-releases-2-8-3-creating-a-new-storm-project--)
  - [2.8.7](/releases/2.8.7/index.html)
  - [2.8.6](/releases/2.8.6/index.html)
  - [2.8.5](/releases/2.8.5/index.html)
  - [Older Versions](/older-releases.html)
- [Talks and Slideshows](/talksAndVideos.html)
- [Community ](#storm-apache-org-releases-2-8-3-creating-a-new-storm-project--)
  - [Contributing](/contribute/Contributing-to-Storm.html)
  - [People](/contribute/People.html)
  - [ByLaws](/contribute/BYLAWS.html)
  - [PoweredBy](/Powered-By.html)
...
Follow along to see how to set up the [storm-starter](https://github.com/apache/storm/blob/v2.8.3/examples/storm-starter) project in Eclipse.

### Add Storm jars to classpath

You'll need the Storm jars on your classpath to develop Storm topologies. Using [Maven](#storm-apache-org-releases-2-8-3-maven) is highly recommended. [Here's an example](https://github.com/apache/storm/blob/v2.8.3/examples/storm-starter/pom.xml) of how to setup your pom.xml for a Storm project. If you don't want to use Maven, you can include the jars from the Storm release on your classpath.
...
For more information on writing topologies in other languages, see [Using non-JVM languages with Storm](#storm-apache-org-releases-2-8-3-using-non-jvm-languages-with-storm).
...
[](#storm-apache-org-releases-2-8-3-creating-a-new-storm-project--)

---

<a id="storm-apache-org-releases-2-8-3-lifecycle-of-a-topology"></a>
...
- [Security](/security-model.html)
- [Project Information](/about/integrates.html)
- [Documentation ](#storm-apache-org-releases-2-8-3-lifecycle-of-a-topology--)
  - [2.8.7](/releases/2.8.7/index.html)
  - [2.8.6](/releases/2.8.6/index.html)
  - [2.8.5](/releases/2.8.5/index.html)
  - [Older Versions](/older-releases.html)
- [Talks and Slideshows](/talksAndVideos.html)
- [Community ](#storm-apache-org-releases-2-8-3-lifecycle-of-a-topology--)
  - [Contributing](/contribute/Contributing-to-Storm.html)
  - [People](/contribute/People.html)
  - [ByLaws](/contribute/BYLAWS.html)
  - [PoweredBy](/Powered-By.html)
...
[](#storm-apache-org-releases-2-8-3-lifecycle-of-a-topology--)

---

<a id="storm-apache-org-releases-2-8-3-message-passing-implementation"></a>
...
- [Security](/security-model.html)
- [Project Information](/about/integrates.html)
- [Documentation ](#storm-apache-org-releases-2-8-3-message-passing-implementation--)
  - [2.8.7](/releases/2.8.7/index.html)
  - [2.8.6](/releases/2.8.6/index.html)
  - [2.8.5](/releases/2.8.5/index.html)
  - [Older Versions](/older-releases.html)
- [Talks and Slideshows](/talksAndVideos.html)
- [Community ](#storm-apache-org-releases-2-8-3-message-passing-implementation--)
  - [Contributing](/contribute/Contributing-to-Storm.html)
  - [People](/contribute/People.html)
  - [ByLaws](/contribute/BYLAWS.html)
  - [PoweredBy](/Powered-By.html)
...
[](#storm-apache-org-releases-2-8-3-message-passing-implementation--)

---

<a id="storm-apache-org-releases-2-8-3-performance"></a>
...
- [Security](/security-model.html)
- [Project Information](/about/integrates.html)
- [Documentation ](#storm-apache-org-releases-2-8-3-performance--)
  - [2.8.7](/releases/2.8.7/index.html)
  - [2.8.6](/releases/2.8.6/index.html)
  - [2.8.5](/releases/2.8.5/index.html)
  - [Older Versions](/older-releases.html)
- [Talks and Slideshows](/talksAndVideos.html)
- [Community ](#storm-apache-org-releases-2-8-3-performance--)
  - [Contributing](/contribute/Contributing-to-Storm.html)
  - [People](/contribute/People.html)
  - [ByLaws](/contribute/BYLAWS.html)
  - [PoweredBy](/Powered-By.html)
...
[](#storm-apache-org-releases-2-8-3-performance--)

---

<a id="storm-apache-org-releases-2-8-3-serialization-prior-to-0-6-0"></a>
...
- [Security](/security-model.html)
- [Project Information](/about/integrates.html)
- [Documentation ](#storm-apache-org-releases-2-8-3-serialization-prior-to-0-6-0--)
  - [2.8.7](/releases/2.8.7/index.html)
  - [2.8.6](/releases/2.8.6/index.html)
  - [2.8.5](/releases/2.8.5/index.html)
  - [Older Versions](/older-releases.html)
- [Talks and Slideshows](/talksAndVideos.html)
- [Community ](#storm-apache-org-releases-2-8-3-serialization-prior-to-0-6-0--)
  - [Contributing](/contribute/Contributing-to-Storm.html)
  - [People](/contribute/People.html)
  - [ByLaws](/contribute/BYLAWS.html)
  - [PoweredBy](/Powered-By.html)
...
Once you create a serializer, you need to tell Storm it exists. This is done through the Storm configuration (See [Concepts](#storm-apache-org-releases-2-8-3-concepts) for information about how configuration works in Storm). You can register serializations either through the config given when submitting a topology or in the storm.yaml files across your cluster.

Serializer registrations are done through the Config.TOPOLOGY\_SERIALIZATIONS config and is simply a list of serialization class names.
...
There's an advanced config called Config.TOPOLOGY\_SKIP\_MISSING\_SERIALIZATIONS. If you set this to true, Storm will ignore any serializations that are registered but do not have their code available on the classpath. Otherwise, Storm will throw errors when it can't find a serialization. This is useful if you run many topologies on a cluster that each have different serializations, but you want to declare all the serializations across all topologies in the `storm.yaml` files.
...
[](#storm-apache-org-releases-2-8-3-serialization-prior-to-0-6-0--)

---

<a id="storm-apache-org-releases-2-8-3-setting-up-development-environment"></a>
...
- [Security](/security-model.html)
- [Project Information](/about/integrates.html)
- [Documentation ](#storm-apache-org-releases-2-8-3-setting-up-development-environment--)
  - [2.8.7](/releases/2.8.7/index.html)
  - [2.8.6](/releases/2.8.6/index.html)
  - [2.8.5](/releases/2.8.5/index.html)
  - [Older Versions](/older-releases.html)
- [Talks and Slideshows](/talksAndVideos.html)
- [Community ](#storm-apache-org-releases-2-8-3-setting-up-development-environment--)
  - [Contributing](/contribute/Contributing-to-Storm.html)
  - [People](/contribute/People.html)
  - [ByLaws](/contribute/BYLAWS.html)
  - [PoweredBy](/Powered-By.html)
...
Installing a Storm release locally is only for interacting with remote clusters. For developing and testing topologies in local mode, it is recommended that you use Maven to include Storm as a dev dependency for your project. You can read more about using Maven for this purpose on [Maven](#storm-apache-org-releases-2-8-3-maven).
...
[](#storm-apache-org-releases-2-8-3-setting-up-development-environment--)

---

<a id="storm-apache-org-releases-2-8-3-structure-of-the-codebase"></a>
...
- [Security](/security-model.html)
- [Project Information](/about/integrates.html)
- [Documentation ](#storm-apache-org-releases-2-8-3-structure-of-the-codebase--)
  - [2.8.7](/releases/2.8.7/index.html)
  - [2.8.6](/releases/2.8.6/index.html)
  - [2.8.5](/releases/2.8.5/index.html)
  - [Older Versions](/older-releases.html)
- [Talks and Slideshows](/talksAndVideos.html)
- [Community ](#storm-apache-org-releases-2-8-3-structure-of-the-codebase--)
  - [Contributing](/contribute/Contributing-to-Storm.html)
  - [People](/contribute/People.html)
  - [ByLaws](/contribute/BYLAWS.html)
  - [PoweredBy](/Powered-By.html)
...
4. The component-specific [configuration](#storm-apache-org-releases-2-8-3-configuration) for this component

Note that the structure spouts also have a `ComponentCommon` field, and so spouts can also have declarations to consume other input streams. Yet the Storm Java API does not provide a way for spouts to consume other streams, and if you put any input declarations there for a spout you would get an error when you tried to submit the topology. The reason that spouts have an input declarations field is not for users to use, but for Storm itself to use. Storm adds implicit streams and bolts to the topology to set up the [acking framework](#storm-apache-org-releases-2-8-3-acking-framework-implementation), and two of these implicit streams are from the acker bolt to each spout in the topology. The acker sends "ack" or "fail" messages along these streams whenever a tuple tree is detected to be completed or failed. The code that transforms the user's topology into the runtime topology is located [here](https://github.com/apache/storm/blob/v2.8.3/storm-client/src/jvm/org/apache/storm/daemon/StormCommon.java).
...
[org.apache.storm.hooks](https://github.com/apache/storm/tree/v2.8.3/storm-client/src/jvm/org/apache/storm/hooks): Interfaces for hooking into various events in Storm, such as when tasks emit tuples, when tuples are acked, etc. User guide for hooks is [here](#storm-apache-org-releases-2-8-3-hooks).
...
[org.apache.storm.config](https://github.com/apache/storm/blob/v2.8.3/storm-clojure/src/clj/org/apache/storm/config.clj): Created clojure symbols for config names in [Config.java](javadocs/org/apache/storm/Config.html)
...
[](#storm-apache-org-releases-2-8-3-structure-of-the-codebase--)

---

<a id="storm-apache-org-releases-2-8-3-transactional-topologies"></a>
...
- [Security](/security-model.html)
- [Project Information](/about/integrates.html)
- [Documentation ](#storm-apache-org-releases-2-8-3-transactional-topologies--)
  - [2.8.7](/releases/2.8.7/index.html)
  - [2.8.6](/releases/2.8.6/index.html)
  - [2.8.5](/releases/2.8.5/index.html)
  - [Older Versions](/older-releases.html)
- [Talks and Slideshows](/talksAndVideos.html)
- [Community ](#storm-apache-org-releases-2-8-3-transactional-topologies--)
  - [Contributing](/contribute/Contributing-to-Storm.html)
  - [People](/contribute/People.html)
  - [ByLaws](/contribute/BYLAWS.html)
  - [PoweredBy](/Powered-By.html)
...
**NOTE**: Transactional topologies have been deprecated -- use the [Trident](#storm-apache-org-releases-2-8-3-trident-tutorial) framework instead.

---

Storm [guarantees data processing](#storm-apache-org-releases-2-8-3-guaranteeing-message-processing) by providing an at least once processing guarantee. The most common question asked about Storm is "Given that tuples can be replayed, how do you do things like counting on top of Storm? Won't you overcount?"
...
Like [Distributed RPC](#storm-apache-org-releases-2-8-3-distributed-rpc), transactional topologies aren't so much a feature of Storm as they are a higher level abstraction built on top of Storm's primitives of streams, spouts, bolts, and topologies.
...
![Storm cluster](storm.apache.org/releases/2.8.3/images/transactional-batches.png)
...
![Storm cluster](storm.apache.org/releases/2.8.3/images/transactional-design-2.png)
...
You build transactional topologies by using [TransactionalTopologyBuilder](javadocs/org/apache/storm/transactional/TransactionalTopologyBuilder.html). Here's the transactional topology definition for a topology that computes the global count of tuples from the input stream. This code comes from [TransactionalGlobalCount](https://github.com/apache/storm/blob/v2.8.3/examples/storm-starter/src/jvm/org/apache/storm/starter/TransactionalGlobalCount.java) in storm-starter.
...
A more involved transactional topology example that updates multiple databases idempotently can be found in storm-starter in the [TransactionalWords](https://github.com/apache/storm/blob/v2.8.3/examples/storm-starter/src/jvm/org/apache/storm/starter/TransactionalWords.java) class.
...
![Storm cluster](storm.apache.org/releases/2.8.3/images/transactional-commit-flow.png)
...
![Storm cluster](storm.apache.org/releases/2.8.3/images/transactional-spout-structure.png)
...
[](#storm-apache-org-releases-2-8-3-transactional-topologies--)

---

<a id="storm-apache-org-releases-2-8-3-nimbus-ha-design"></a>
...
- [Security](/security-model.html)
- [Project Information](/about/integrates.html)
- [Documentation ](#storm-apache-org-releases-2-8-3-nimbus-ha-design--)
  - [2.8.7](/releases/2.8.7/index.html)
  - [2.8.6](/releases/2.8.6/index.html)
  - [2.8.5](/releases/2.8.5/index.html)
  - [Older Versions](/older-releases.html)
- [Talks and Slideshows](/talksAndVideos.html)
- [Community ](#storm-apache-org-releases-2-8-3-nimbus-ha-design--)
  - [Contributing](/contribute/Contributing-to-Storm.html)
  - [People](/contribute/People.html)
  - [ByLaws](/contribute/BYLAWS.html)
  - [PoweredBy](/Powered-By.html)
...
![Nimbus Fail Over](storm.apache.org/releases/2.8.3/images/nimbus_ha_leader_election_and_failover.png)
...
![Nimbus HA Topology Submission](storm.apache.org/releases/2.8.3/images/nimbus_ha_topology_submission.png)
...
[](#storm-apache-org-releases-2-8-3-nimbus-ha-design--)

---

<a id="storm-apache-org-releases-2-8-3-storm-jms-example"></a>
...
- [Security](/security-model.html)
- [Project Information](/about/integrates.html)
- [Documentation ](#storm-apache-org-releases-2-8-3-storm-jms-example--)
  - [2.8.7](/releases/2.8.7/index.html)
  - [2.8.6](/releases/2.8.6/index.html)
  - [2.8.5](/releases/2.8.5/index.html)
  - [Older Versions](/older-releases.html)
- [Talks and Slideshows](/talksAndVideos.html)
- [Community ](#storm-apache-org-releases-2-8-3-storm-jms-example--)
  - [Contributing](/contribute/Contributing-to-Storm.html)
  - [People](/contribute/People.html)
  - [ByLaws](/contribute/BYLAWS.html)
  - [PoweredBy](/Powered-By.html)
...
![picture alt](storm.apache.org/releases/2.8.3/images/Storm-JMS-Example.png "Example JMS Topology")
...
1. Open the ActiveMQ Queue admin console: [http://localhost:8161/admin/queues.jsp](http://localhost:8161/admin/queues.jsp)
...
[](#storm-apache-org-releases-2-8-3-storm-jms-example--)

---

<a id="storm-apache-org-releases-2-8-3-storm-jms-spring"></a>
...
- [Security](/security-model.html)
- [Project Information](/about/integrates.html)
- [Documentation ](#storm-apache-org-releases-2-8-3-storm-jms-spring--)
  - [2.8.7](/releases/2.8.7/index.html)
  - [2.8.6](/releases/2.8.6/index.html)
  - [2.8.5](/releases/2.8.5/index.html)
  - [Older Versions](/older-releases.html)
- [Talks and Slideshows](/talksAndVideos.html)
- [Community ](#storm-apache-org-releases-2-8-3-storm-jms-spring--)
  - [Contributing](/contribute/Contributing-to-Storm.html)
  - [People](/contribute/People.html)
  - [ByLaws](/contribute/BYLAWS.html)
  - [PoweredBy](/Powered-By.html)
...
[](#storm-apache-org-releases-2-8-3-storm-jms-spring--)