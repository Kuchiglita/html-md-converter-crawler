<a id="db-apache-org-torque-torque-7-1-documentation-tutorial-index"></a>

# Torque 4 Tutorial – Apache Db Torque

<a id="db-apache-org-torque-torque-7-1-documentation-tutorial-index--About_this_Tutorial"></a>
...
[Torque templates documentation](../modules/templates/index.html)
and
[Torque runtime documentation](../modules/runtime/index.html)
for more detailed information about the ORM part, and to the
[Torque generator documentation](../modules/generator/index.html)
...
in the
[Torque Wiki](https://cwiki.apache.org/confluence/display/DBTORQUE/Home),
...
<a id="db-apache-org-torque-torque-7-1-documentation-tutorial-index--Torque_modules"></a>
...
<a id="db-apache-org-torque-torque-7-1-documentation-tutorial-index--Where_to_next"></a>
...
[configuring Maven for Torque](#db-apache-org-torque-torque-7-1-documentation-tutorial-orm-step1-maven).
If you plan to use ant, look at
[configuring Ant for Torque](#db-apache-org-torque-torque-7-1-documentation-tutorial-orm-step1-ant)
For the code generation part, see
[getting started with Torque code generation](#db-apache-org-torque-torque-7-1-documentation-tutorial-codegen-gettingstarted).

<a id="db-apache-org-torque-torque-7-1-documentation-tutorial-index--User_Comments"></a>
...
<a id="db-apache-org-torque-torque-7-1-documentation-tutorial-codegen-gettingstarted"></a>

# Getting Started with Torque code generation – Apache Db Torque

<a id="db-apache-org-torque-torque-7-1-documentation-tutorial-codegen-gettingstarted--Introduction"></a>
...
<a id="db-apache-org-torque-torque-7-1-documentation-tutorial-codegen-gettingstarted--Project_setup"></a>
...
<a id="db-apache-org-torque-torque-7-1-documentation-tutorial-codegen-gettingstarted--Creating_a_sample_source"></a>
...
<a id="db-apache-org-torque-torque-7-1-documentation-tutorial-codegen-gettingstarted--Creating_the_templates"></a>
...
[its javadoc](../../modules/generator/reports/apidocs/org/apache/torque/generator/template/velocity/TorqueGenVelocity.html)
...
[the SourceElement javadoc](../../modules/generator/reports/apidocs/org/apache/torque/generator/source/SourceElement.html)
...
<a id="db-apache-org-torque-torque-7-1-documentation-tutorial-codegen-gettingstarted--Creating_the_control_file"></a>
...
<a id="db-apache-org-torque-torque-7-1-documentation-tutorial-codegen-gettingstarted--Configuring_the_outlets"></a>
...
<a id="db-apache-org-torque-torque-7-1-documentation-tutorial-codegen-gettingstarted--Generating_the_source"></a>
...
<a id="db-apache-org-torque-torque-7-1-documentation-tutorial-codegen-gettingstarted--Using_the_Torque_Maven_plugin"></a>
...
<a id="db-apache-org-torque-torque-7-1-documentation-tutorial-codegen-gettingstarted--Using_plain_java"></a>
...
<a id="db-apache-org-torque-torque-7-1-documentation-tutorial-orm-index"></a>

# Torque ORM Tutorial – Apache Db Torque

<a id="db-apache-org-torque-torque-7-1-documentation-tutorial-orm-index--Torque_ORM_Tutorial"></a>
...
- Step 1: Configuring the Torque generation process
  (for [ant](#db-apache-org-torque-torque-7-1-documentation-tutorial-orm-step1-ant) or
  [maven](#db-apache-org-torque-torque-7-1-documentation-tutorial-orm-step1-maven))
- Step 2: [Defining the database schema](#db-apache-org-torque-torque-7-1-documentation-tutorial-orm-step2)
- Step 3: Invoking the Torque generator
  (for [ant](#db-apache-org-torque-torque-7-1-documentation-tutorial-orm-step3-ant) or
  [maven](#db-apache-org-torque-torque-7-1-documentation-tutorial-orm-step3-maven))
- Step 4: [Configuring the Torque Runtime](#db-apache-org-torque-torque-7-1-documentation-tutorial-orm-step4)
- Step 5: [Writing a Sample Application](#db-apache-org-torque-torque-7-1-documentation-tutorial-orm-step5)
- Step 6: Compiling and Running the Sample Application
  (for [ant](#db-apache-org-torque-torque-7-1-documentation-tutorial-orm-step6-ant) or
  [maven](#db-apache-org-torque-torque-7-1-documentation-tutorial-orm-step6-maven))

---

<a id="db-apache-org-torque-torque-7-1-documentation-tutorial-orm-step1-ant"></a>

# Torque ORM Tutorial - Step 1: Configuring the Torque generation process using Ant – Apache Db Torque

<a id="db-apache-org-torque-torque-7-1-documentation-tutorial-orm-step1-ant--Step_1.3A_Configuring_the_Torque_generation_process"></a>
...
<a id="db-apache-org-torque-torque-7-1-documentation-tutorial-orm-step1-ant--Ant_build_file"></a>
...
<a id="db-apache-org-torque-torque-7-1-documentation-tutorial-orm-step1-ant--Library_set-up"></a>
...
<a id="db-apache-org-torque-torque-7-1-documentation-tutorial-orm-step1-ant--Where_to_next"></a>
...
[Defining the database schema](#db-apache-org-torque-torque-7-1-documentation-tutorial-orm-step2).

<a id="db-apache-org-torque-torque-7-1-documentation-tutorial-orm-step1-ant--User_Comments"></a>
...
<a id="db-apache-org-torque-torque-7-1-documentation-tutorial-orm-step1-maven"></a>

# Torque ORM Tutorial - Step 1: Configuring the Torque generation process using maven 2 – Apache Db Torque

<a id="db-apache-org-torque-torque-7-1-documentation-tutorial-orm-step1-maven--Step_1.3A_Configuring_the_Torque_generation_process"></a>
...
<a id="db-apache-org-torque-torque-7-1-documentation-tutorial-orm-step1-maven--Maven_Project_descriptor"></a>
...
<a id="db-apache-org-torque-torque-7-1-documentation-tutorial-orm-step1-maven--Where_to_next"></a>
...
<a id="db-apache-org-torque-torque-7-1-documentation-tutorial-orm-step1-maven--User_Comments"></a>
...
<a id="db-apache-org-torque-torque-7-1-documentation-tutorial-orm-step2"></a>

# Torque ORM Tutorial - Step 2: Defining the database schema – Apache Db Torque

<a id="db-apache-org-torque-torque-7-1-documentation-tutorial-orm-step2--Step_2.3A_Defining_the_Torque_Database_Schema"></a>
...
| idbroker | Instructs Torque to use itsIDBrokerservice to generate IDs in a database agnostic manner.       An extra table is used for this, which needs to be created separately. |
...
- 4.0 strict schema or default
  [strict Schema XSD](../../orm-reference/database-4-0-strict.xsd)
  or the
  [Schema XSD](../../orm-reference/database-4-0.xsd)
- 5.0 strict schema or default
  [strict Schema XSD](../../orm-reference/database-5-0-strict.xsd)
  or the
  [Schema XSD](../../orm-reference/database-5-0.xsd)
...
[Schema XSD](../../orm-reference/database-4-0.xsd)
or [5.0 Schema XSD](../../orm-reference/database-5-0.xsd).

<a id="db-apache-org-torque-torque-7-1-documentation-tutorial-orm-step2--Where_to_next"></a>
...
[Invoking the Torque Maven plugin](#db-apache-org-torque-torque-7-1-documentation-tutorial-orm-step3-maven),
wheras ant users should go to
[Invoking the ant build containing Torque](#db-apache-org-torque-torque-7-1-documentation-tutorial-orm-step3-ant).

<a id="db-apache-org-torque-torque-7-1-documentation-tutorial-orm-step2--User_Comments"></a>
...
<a id="db-apache-org-torque-torque-7-1-documentation-tutorial-orm-step3-ant"></a>

# Torque Tutorial - Step 3: Invoking the Torque Ant task – Apache Db Torque

<a id="db-apache-org-torque-torque-7-1-documentation-tutorial-orm-step3-ant--Step_3.3A_Invoking_the_Torque_Ant_Task"></a>
...
*book* table, defined in this tutorial,
...
![generated classes](db.apache.org/torque/torque-7.1/images/generated-classes.png)
...
<a id="db-apache-org-torque-torque-7-1-documentation-tutorial-orm-step3-ant--Creating_the_Database_Tables"></a>
...
<a id="db-apache-org-torque-torque-7-1-documentation-tutorial-orm-step3-ant--Creating_the_tables"></a>
...
<a id="db-apache-org-torque-torque-7-1-documentation-tutorial-orm-step3-ant--Where_to_next"></a>
...
Next we will look [Configuring the Torque Runtime](#db-apache-org-torque-torque-7-1-documentation-tutorial-orm-step4).

<a id="db-apache-org-torque-torque-7-1-documentation-tutorial-orm-step3-ant--User_Comments"></a>
...
<a id="db-apache-org-torque-torque-7-1-documentation-tutorial-orm-step3-maven"></a>

# Torque Tutorial - Step 3: Invoking the Torque Maven Plugin – Apache Db Torque

<a id="db-apache-org-torque-torque-7-1-documentation-tutorial-orm-step3-maven--Step_3.3A_Invoking_the_Torque_Maven_Plugin"></a>
...
<a id="db-apache-org-torque-torque-7-1-documentation-tutorial-orm-step3-maven--Creating_the_Database_Tables"></a>
...
<a id="db-apache-org-torque-torque-7-1-documentation-tutorial-orm-step3-maven--Specifying_the_driver_dependency"></a>
...
<a id="db-apache-org-torque-torque-7-1-documentation-tutorial-orm-step3-maven--Creating_the_tables"></a>
...
<a id="db-apache-org-torque-torque-7-1-documentation-tutorial-orm-step3-maven--Where_to_next"></a>
...
<a id="db-apache-org-torque-torque-7-1-documentation-tutorial-orm-step3-maven--User_Comments"></a>
...
<a id="db-apache-org-torque-torque-7-1-documentation-tutorial-orm-step4"></a>

# Torque Tutorial - Step 4: Configuring the Torque Runtime – Apache Db Torque

<a id="db-apache-org-torque-torque-7-1-documentation-tutorial-orm-step4--Step_4.3A_Configuring_the_Torque_Runtime"></a>
...
<a id="db-apache-org-torque-torque-7-1-documentation-tutorial-orm-step4--Torque_Runtime_Properties"></a>
...
[Runtime Configuration Reference](../../orm-reference/initialisation-configuration.html#Configuration).
...
| torque.database.XXX.connection.url | The URL that will be used to access your         database.  Torque's generated object model         will perform all database operations using         this URL.  This value should reflect the         database name specified in your database         schema file (see thedatabaseelement'snameattribute). |
| torque.database.XXX.connection.user | The username that has sufficient privileges         to access your database.  This user does not         require privileges to create and drop         tables, unlike the user that was         specified inproject.properties. |
...
<a id="db-apache-org-torque-torque-7-1-documentation-tutorial-orm-step4--Logging_configuration"></a>
...
<a id="db-apache-org-torque-torque-7-1-documentation-tutorial-orm-step4--Where_to_next"></a>
...
Next we will look [Writing a Sample Application](#db-apache-org-torque-torque-7-1-documentation-tutorial-orm-step5).

<a id="db-apache-org-torque-torque-7-1-documentation-tutorial-orm-step4--User_Comments"></a>
...
<a id="db-apache-org-torque-torque-7-1-documentation-tutorial-orm-step5"></a>

# Torque Tutorial - Step 5 - Writing a Sample Application – Apache Db Torque

<a id="db-apache-org-torque-torque-7-1-documentation-tutorial-orm-step5--Step_5.3A_Writing_a_Sample_Application"></a>
...
[Runtime relevant classes documentation](../../orm-reference/relevant-classes.html).
...
<a id="db-apache-org-torque-torque-7-1-documentation-tutorial-orm-step5--Inserting_Rows"></a>
...
<a id="db-apache-org-torque-torque-7-1-documentation-tutorial-orm-step5--Selecting_Rows"></a>
...
[Reading
from the Database Reference](../../orm-reference/read-from-db.html).

<a id="db-apache-org-torque-torque-7-1-documentation-tutorial-orm-step5--Updating_Rows"></a>
...
<a id="db-apache-org-torque-torque-7-1-documentation-tutorial-orm-step5--Deleting_Rows"></a>
...
<a id="db-apache-org-torque-torque-7-1-documentation-tutorial-orm-step5--Adding_Functionality_to_the_Object_Model"></a>
...
suggestion in the
[Reading
from the Database Reference](../../orm-reference/read-from-db.html)) we'll add *doSelectAll*
...
<a id="db-apache-org-torque-torque-7-1-documentation-tutorial-orm-step5--Full_Application"></a>
...
<a id="db-apache-org-torque-torque-7-1-documentation-tutorial-orm-step5--Where_to_next"></a>
...
Maven users please look [here](#db-apache-org-torque-torque-7-1-documentation-tutorial-orm-step6-maven), and ant users
please look [here](#db-apache-org-torque-torque-7-1-documentation-tutorial-orm-step6-ant)

<a id="db-apache-org-torque-torque-7-1-documentation-tutorial-orm-step5--User_Comments"></a>
...
<a id="db-apache-org-torque-torque-7-1-documentation-tutorial-orm-step6-ant"></a>

# Torque Tutorial - Step 6 - Compiling and Running the Sample Application – Apache Db Torque

<a id="db-apache-org-torque-torque-7-1-documentation-tutorial-orm-step6-ant--Step_6.3A_Compiling_and_Running_the_sample_application_using_ant"></a>

# Step 6: Compiling and Running the sample application using ant

<a id="db-apache-org-torque-torque-7-1-documentation-tutorial-orm-step6-ant--Setting_up_the_classpath"></a>
...
<a id="db-apache-org-torque-torque-7-1-documentation-tutorial-orm-step6-ant--Building_the_sample_application"></a>
...
<a id="db-apache-org-torque-torque-7-1-documentation-tutorial-orm-step6-ant--Running_the_sample_application"></a>
...
[mailing list](../../../mail-lists.html) to your
advantage.

<a id="db-apache-org-torque-torque-7-1-documentation-tutorial-orm-step6-ant--Where_to_Go_From_Here"></a>
...
<a id="db-apache-org-torque-torque-7-1-documentation-tutorial-orm-step6-ant--User_Comments"></a>
...
<a id="db-apache-org-torque-torque-7-1-documentation-tutorial-orm-step6-maven"></a>

# Torque Tutorial - Step 6 - Compiling and Running the Sample Application using Maven – Apache Db Torque

<a id="db-apache-org-torque-torque-7-1-documentation-tutorial-orm-step6-maven--Step_6.3A_Compiling_and_Running_the_sample_application"></a>

# Step 6: Compiling and Running the sample application

<a id="db-apache-org-torque-torque-7-1-documentation-tutorial-orm-step6-maven--Setting_up_the_classpath"></a>
...
<a id="db-apache-org-torque-torque-7-1-documentation-tutorial-orm-step6-maven--Building_the_sample_application"></a>
...
<a id="db-apache-org-torque-torque-7-1-documentation-tutorial-orm-step6-maven--Running_the_sample_application"></a>
...
<a id="db-apache-org-torque-torque-7-1-documentation-tutorial-orm-step6-maven--Where_to_Go_From_Here"></a>
...
<a id="db-apache-org-torque-torque-7-1-documentation-tutorial-orm-step6-maven--User_Comments"></a>
