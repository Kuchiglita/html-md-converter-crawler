# <a id="d5e1"></a>Apache OpenNLP Developer Documentation
...
- [1. Introduction](#opennlp)
  - [Description](#intro.description)
  - [General Library Structure](#intro.general.library.structure)
  - [Application Program Interface (API). Generic Example](#intro.api)
  - [Command line interface (CLI)](#intro.cli)
    - [Description](#intro.cli.description)
    - [List of tools](#intro.cli.toolslist)
    - [Setting up](#intro.cli.setup)
    - [Generic Example](#intro.cli.generic)
  - [OpenNLP Models](#intro.models)
    - [OpenNLP Models](#intro.models.native)
    - [ONNX Models](#intro.models.onnx)
  - [System Properties](#intro.sysprops)
    - [String Interning](#intro.sysprops.interner)
- [2. Language Detector](#tools.langdetect)
  - [Classifying](#tools.langdetect.classifying)
  - [Language Detector Tool](#tools.langdetect.classifying.cmdline)
  - [Language Detector API](#tools.langdetect.classifying.api)
  - [Training](#tools.langdetect.training)
    - [Training Tool](#tools.langdetect.training.tool)
    - [Training with Leipzig](#tools.langdetect.training.leipzig)
    - [Training API](#tools.langdetect.training.api)
- [3. Sentence Detector](#tools.sentdetect)
  - [Sentence Detection](#tools.sentdetect.detection)
    - [Sentence Detection Tool](#tools.sentdetect.detection.cmdline)
    - [Sentence Detection API](#tools.sentdetect.detection.api)
  - [Sentence Detector Training](#tools.sentdetect.training)
    - [Training Tool](#tools.sentdetect.training.tool)
    - [Training API](#tools.sentdetect.training.api)
  - [Evaluation](#tools.sentdetect.eval)
    - [Evaluation Tool](#tools.sentdetect.eval.tool)
- [4. Tokenizer](#tools.tokenizer)
  - [Tokenization](#tools.tokenizer.introduction)
    - [Tokenizer Tools](#tools.tokenizer.cmdline)
    - [Tokenizer API](#tools.tokenizer.api)
  - [Tokenizer Training](#tools.tokenizer.training)
    - [Training Tool](#tools.tokenizer.training.tool)
    - [Training API](#tools.tokenizer.training.api)
  - [Detokenizing](#tools.tokenizer.detokenizing)
    - [Detokenizing API](#tools.tokenizer.detokenizing.api)
    - [Detokenizer Dictionary](#tools.tokenizer.detokenizing.dict)
- [5. Name Finder](#tools.namefind)
  - [Named Entity Recognition](#tools.namefind.recognition)
    - [Name Finder Tool](#tools.namefind.recognition.cmdline)
    - [Name Finder API](#tools.namefind.recognition.api)
      - [Using an ONNX Model](#tools.namefind.api.onnx)
  - [Name Finder Training](#tools.namefind.training)
    - [Training Tool](#tools.namefind.training.tool)
    - [Training API](#tools.namefind.training.api)
    - [Custom Feature Generation](#tools.namefind.training.featuregen)
  ...
  - [Evaluation](#tools.namefind.eval)
    - [Evaluation Tool](#tools.namefind.eval.tool)
    - [Evaluation API](#tools.namefind.eval.api)
  - [Named Entity Annotation Guidelines](#tools.namefind.annotation_guides)
- [6. Document Categorizer](#tools.doccat)
  - [Classifying](#tools.doccat.classifying)
    - [Document Categorizer Tool](#tools.doccat.classifying.cmdline)
    - [Document Categorizer API](#tools.doccat.classifying.api)
      - [Using an ONNX Model](#tools.namefind.api.onnx)
  - [Training](#tools.doccat.training)
    - [Training Tool](#tools.doccat.training.tool)
    - [Training API](#tools.doccat.training.api)
- [7. Part-of-Speech Tagger](#tools.postagger)
  - [Tagging](#tools.postagger.tagging)
    - [POS Tagger Tool](#tools.postagger.tagging.cmdline)
    - [POS Tagger API](#tools.postagger.tagging.api)
  - [Training](#tools.postagger.training)
    - [Training Tool](#tools.postagger.training.tool)
    - [Training API](#tools.postagger.training.api)
    - [Tag Dictionary](#tools.postagger.training.tagdict)
  - [Evaluation](#tools.postagger.eval)
    - [Evaluation Tool](#tools.postagger.eval.tool)
- [8. Lemmatizer](#tools.lemmatizer)
  - [Lemmatizer Tool](#tools.lemmatizer.tagging.cmdline)
  - [Lemmatizer API](#tools.lemmatizer.tagging.api)
  - [Lemmatizer Training](#tools.lemmatizer.training)
    - [Training Tool](#tools.lemmatizer.training.tool)
    - [Training API](#tools.lemmatizer.training.api)
  - [Lemmatizer Evaluation](#tools.lemmatizer.evaluation)
- [9. Chunker](#tools.chunker)
  - [Chunking](#tools.parser.chunking)
    - [Chunker Tool](#tools.parser.chunking.cmdline)
    - [Chunking API](#tools.parser.chunking.api)
  - [Chunker Training](#tools.chunker.training)
    - [Training Tool](#tools.chunker.training.tool)
    - [Training API](#tools.chunker.training.api)
  - [Chunker Evaluation](#tools.chunker.evaluation)
    - [Chunker Evaluation Tool](#tools.chunker.evaluation.tool)
- [10. Parser](#tools.parser)
  - [Parsing](#tools.parser.parsing)
    - [Parser Tool](#tools.parser.parsing.cmdline)
    - [Parsing API](#tools.parser.parsing.api)
  - [Parser Training](#tools.parser.training)
    - [Training Tool](#tools.parser.training.tool)
    - [Training API](#tools.parser.training.api)
  - [Parser Evaluation](#tools.parser.evaluation)
    - [Parser Evaluation Tool](#tools.parser.evaluation.tool)
    - [Evaluation API](#tools.parser.evaluation.api)
- [11. Coreference Resolution](#tools.coref)
- [12. Classpath Loading of OpenNLP Models](#tools.model)
  - [Loading a pre-trained OpenNLP model from the classpath](#tools.model.load)
  - [Bundling a custom trained OpenNLP model for the classpath](#tools.model.bundle)
- [13. Extending OpenNLP](#tools.extension)
  - [Writing an extension](#tools.extension.writing)
- [14. Corpora](#tools.corpora)
  - [CONLL](#tools.corpora.conll)
    - [CONLL 2000](#tools.corpora.conll.2000)
    ...
    - [CONLL 2002](#tools.corpora.conll.2002)
    ...
    - [CONLL 2003](#tools.corpora.conll.2003)
  ...
  - [Arvores Deitadas](#tools.corpora.arvores-deitadas)
    - [Getting the data](#tools.corpora.arvores-deitadas.getting)
    - [Converting the data (optional)](#tools.corpora.arvores-deitadas.converting)
    - [Training and Evaluation](#tools.corpora.arvores-deitadas.evaluation)
  - [OntoNotes Release 4.0](#tools.corpora.ontonotes)
    - [Name Finder Training](#tools.corpora.ontonotes.namefinder)
  - [Brat Format Support](#tools.corpora.brat)
    - [Training](#tools.corpora.brat.training)
    - [Evaluation](#tools.corpora.brat.evaluation)
    - [Cross Validation](#tools.corpora.brat.cross-validation)
- [15. Machine Learning](#opennlp.ml)
  - [Maximum Entropy](#opennlp.ml.maxent)
    - [Implementation](#opennlp.ml.maxent.impl)
- [16. UIMA Integration](#org.apache.opennlp.uima)
  - [Running the pear sample in CVD](#org.apache.opennlp.running-pear-sample)
  - [Further Help](#org.apache.opennlp.further-help)
- [17. Morfologik Addon](#tools.morfologik-addon)
  - [Morfologik Integration](#tools.morfologik-addon.api)
  - [Morfologik CLI Tools](#tools.morfologik-addon.cmdline)
- [18. The Command Line Interface](#tools.cli)
  - [Doccat](#tools.cli.doccat)
    - [Doccat](#tools.cli.doccat.Doccat)
    - [DoccatTrainer](#tools.cli.doccat.DoccatTrainer)
    - [DoccatEvaluator](#tools.cli.doccat.DoccatEvaluator)
    - [DoccatCrossValidator](#tools.cli.doccat.DoccatCrossValidator)
    - [DoccatConverter](#tools.cli.doccat.DoccatConverter)
  - [Langdetect](#tools.cli.langdetect)
    - [LanguageDetector](#tools.cli.langdetect.LanguageDetector)
    - [LanguageDetectorTrainer](#tools.cli.langdetect.LanguageDetectorTrainer)
    - [LanguageDetectorConverter](#tools.cli.langdetect.LanguageDetectorConverter)
    - [LanguageDetectorCrossValidator](#tools.cli.langdetect.LanguageDetectorCrossValidator)
    - [LanguageDetectorEvaluator](#tools.cli.langdetect.LanguageDetectorEvaluator)
  - [Dictionary](#tools.cli.dictionary)
    - [DictionaryBuilder](#tools.cli.dictionary.DictionaryBuilder)
  - [Tokenizer](#tools.cli.tokenizer)
    - [SimpleTokenizer](#tools.cli.tokenizer.SimpleTokenizer)
    - [TokenizerME](#tools.cli.tokenizer.TokenizerME)
    - [TokenizerTrainer](#tools.cli.tokenizer.TokenizerTrainer)
    - [TokenizerMEEvaluator](#tools.cli.tokenizer.TokenizerMEEvaluator)
    - [TokenizerCrossValidator](#tools.cli.tokenizer.TokenizerCrossValidator)
    - [TokenizerConverter](#tools.cli.tokenizer.TokenizerConverter)
    - [DictionaryDetokenizer](#tools.cli.tokenizer.DictionaryDetokenizer)
  - [Sentdetect](#tools.cli.sentdetect)
    - [SentenceDetector](#tools.cli.sentdetect.SentenceDetector)
    - [SentenceDetectorTrainer](#tools.cli.sentdetect.SentenceDetectorTrainer)
    - [SentenceDetectorEvaluator](#tools.cli.sentdetect.SentenceDetectorEvaluator)
    - [SentenceDetectorCrossValidator](#tools.cli.sentdetect.SentenceDetectorCrossValidator)
    - [SentenceDetectorConverter](#tools.cli.sentdetect.SentenceDetectorConverter)
  - [Namefind](#tools.cli.namefind)
    - [TokenNameFinder](#tools.cli.namefind.TokenNameFinder)
    - [TokenNameFinderTrainer](#tools.cli.namefind.TokenNameFinderTrainer)
    - [TokenNameFinderEvaluator](#tools.cli.namefind.TokenNameFinderEvaluator)
    - [TokenNameFinderCrossValidator](#tools.cli.namefind.TokenNameFinderCrossValidator)
    - [TokenNameFinderConverter](#tools.cli.namefind.TokenNameFinderConverter)
    - [CensusDictionaryCreator](#tools.cli.namefind.CensusDictionaryCreator)
  - [Postag](#tools.cli.postag)
    - [POSTagger](#tools.cli.postag.POSTagger)
    - [POSTaggerTrainer](#tools.cli.postag.POSTaggerTrainer)
    - [POSTaggerEvaluator](#tools.cli.postag.POSTaggerEvaluator)
    - [POSTaggerCrossValidator](#tools.cli.postag.POSTaggerCrossValidator)
    - [POSTaggerConverter](#tools.cli.postag.POSTaggerConverter)
  - [Lemmatizer](#tools.cli.lemmatizer)
    - [LemmatizerME](#tools.cli.lemmatizer.LemmatizerME)
    - [LemmatizerTrainerME](#tools.cli.lemmatizer.LemmatizerTrainerME)
    - [LemmatizerEvaluator](#tools.cli.lemmatizer.LemmatizerEvaluator)
  - [Chunker](#tools.cli.chunker)
    - [ChunkerME](#tools.cli.chunker.ChunkerME)
    - [ChunkerTrainerME](#tools.cli.chunker.ChunkerTrainerME)
    - [ChunkerEvaluator](#tools.cli.chunker.ChunkerEvaluator)
    - [ChunkerCrossValidator](#tools.cli.chunker.ChunkerCrossValidator)
    - [ChunkerConverter](#tools.cli.chunker.ChunkerConverter)
  - [Parser](#tools.cli.parser)
    - [Parser](#tools.cli.parser.Parser)
    - [ParserTrainer](#tools.cli.parser.ParserTrainer)
    - [ParserEvaluator](#tools.cli.parser.ParserEvaluator)
    - [ParserConverter](#tools.cli.parser.ParserConverter)
    - [BuildModelUpdater](#tools.cli.parser.BuildModelUpdater)
    - [CheckModelUpdater](#tools.cli.parser.CheckModelUpdater)
    - [TaggerModelReplacer](#tools.cli.parser.TaggerModelReplacer)
  - [Entitylinker](#tools.cli.entitylinker)
    - [EntityLinker](#tools.cli.entitylinker.EntityLinker)
  - [Languagemodel](#tools.cli.languagemodel)
    - [NGramLanguageModel](#tools.cli.languagemodel.NGramLanguageModel)
- [19. Evaluation Test Data](#opennlp.evaltest)
  - [What is it ?](#opennlp.evaltest.whatisit)
  - [Where is it?](#opennlp.evaltest.whereisit)
  - [How to use the evaluation test data to run test?](#opennlp.evaltest.howtouseit)
  - [How to change evaluation data?](#opennlp.evaltest.howtochangeit)
...
# <a id="opennlp"></a>Chapter 1. Introduction
...
## <a id="intro.description"></a>Description
...
## <a id="intro.general.library.structure"></a>General Library Structure
...
## <a id="intro.api"></a>Application Program Interface (API). Generic Example
...
## <a id="intro.cli"></a>Command line interface (CLI)
...
### <a id="intro.cli.description"></a>Description
...
### <a id="intro.cli.toolslist"></a>List of tools
...
### <a id="intro.cli.setup"></a>Setting up
...
### <a id="intro.cli.generic"></a>Generic Example
...
## <a id="intro.models"></a>OpenNLP Models

- [OpenNLP Models](#intro.models.native)
- [ONNX Models](#intro.models.onnx)

### <a id="intro.models.native"></a>OpenNLP Models
...
### <a id="intro.models.onnx"></a>ONNX Models
...
## <a id="intro.sysprops"></a>System Properties

- [String Interning](#intro.sysprops.interner)

### <a id="intro.sysprops.interner"></a>String Interning
...
# <a id="tools.langdetect"></a>Chapter 2. Language Detector
...
## <a id="tools.langdetect.classifying"></a>Classifying
...
## <a id="tools.langdetect.classifying.cmdline"></a>Language Detector Tool
...
## <a id="tools.langdetect.classifying.api"></a>Language Detector API
...
## <a id="tools.langdetect.training"></a>Training
...
### <a id="tools.langdetect.training.tool"></a>Training Tool
...
### <a id="tools.langdetect.training.leipzig"></a>Training with Leipzig
...
### <a id="tools.langdetect.training.api"></a>Training API
...
# <a id="tools.sentdetect"></a>Chapter 3. Sentence Detector
...
## <a id="tools.sentdetect.detection"></a>Sentence Detection
...
### <a id="tools.sentdetect.detection.cmdline"></a>Sentence Detection Tool
...
### <a id="tools.sentdetect.detection.api"></a>Sentence Detection API
...
## <a id="tools.sentdetect.training"></a>Sentence Detector Training

- [Training Tool](#tools.sentdetect.training.tool)
- [Training API](#tools.sentdetect.training.api)

### <a id="tools.sentdetect.training.tool"></a>Training Tool
...
### <a id="tools.sentdetect.training.api"></a>Training API
...
## <a id="tools.sentdetect.eval"></a>Evaluation

- [Evaluation Tool](#tools.sentdetect.eval.tool)

### <a id="tools.sentdetect.eval.tool"></a>Evaluation Tool
...
# <a id="tools.tokenizer"></a>Chapter 4. Tokenizer
...
## <a id="tools.tokenizer.introduction"></a>Tokenization
...
### <a id="tools.tokenizer.cmdline"></a>Tokenizer Tools
...
### <a id="tools.tokenizer.api"></a>Tokenizer API
...
## <a id="tools.tokenizer.training"></a>Tokenizer Training

- [Training Tool](#tools.tokenizer.training.tool)
- [Training API](#tools.tokenizer.training.api)

### <a id="tools.tokenizer.training.tool"></a>Training Tool
...
### <a id="tools.tokenizer.training.api"></a>Training API
...
## <a id="tools.tokenizer.detokenizing"></a>Detokenizing
...
### <a id="tools.tokenizer.detokenizing.api"></a>Detokenizing API
...
### <a id="tools.tokenizer.detokenizing.dict"></a>Detokenizer Dictionary
...
# <a id="tools.namefind"></a>Chapter 5. Name Finder
...
## <a id="tools.namefind.recognition"></a>Named Entity Recognition
...
### <a id="tools.namefind.recognition.cmdline"></a>Name Finder Tool
...
### <a id="tools.namefind.recognition.api"></a>Name Finder API
...
#### <a id="tools.namefind.api.onnx"></a>Using an ONNX Model
...
## <a id="tools.namefind.training"></a>Name Finder Training
...
### <a id="tools.namefind.training.tool"></a>Training Tool
...
### <a id="tools.namefind.training.api"></a>Training API
...
### <a id="tools.namefind.training.featuregen"></a>Custom Feature Generation
...
#### <a id="tools.namefind.training.featuregen.api"></a>Feature Generation defined by API
...
#### <a id="tools.namefind.training.featuregen.xml"></a>Feature Generation defined by XML Descriptor
...
## <a id="tools.namefind.eval"></a>Evaluation
...
### <a id="tools.namefind.eval.tool"></a>Evaluation Tool
...
### <a id="tools.namefind.eval.api"></a>Evaluation API
...
## <a id="tools.namefind.annotation_guides"></a>Named Entity Annotation Guidelines
...
# <a id="tools.doccat"></a>Chapter 6. Document Categorizer
...
## <a id="tools.doccat.classifying"></a>Classifying
...
### <a id="tools.doccat.classifying.cmdline"></a>Document Categorizer Tool
...
### <a id="tools.doccat.classifying.api"></a>Document Categorizer API
...
## <a id="tools.doccat.training"></a>Training
...
### <a id="tools.doccat.training.tool"></a>Training Tool
...
### <a id="tools.doccat.training.api"></a>Training API
...
# <a id="tools.postagger"></a>Chapter 7. Part-of-Speech Tagger
...
## <a id="tools.postagger.tagging"></a>Tagging
...
### <a id="tools.postagger.tagging.cmdline"></a>POS Tagger Tool
...
### <a id="tools.postagger.tagging.api"></a>POS Tagger API
...
## <a id="tools.postagger.training"></a>Training
...
### <a id="tools.postagger.training.tool"></a>Training Tool
...
### <a id="tools.postagger.training.api"></a>Training API
...
### <a id="tools.postagger.training.tagdict"></a>Tag Dictionary
...
## <a id="tools.postagger.eval"></a>Evaluation
...
### <a id="tools.postagger.eval.tool"></a>Evaluation Tool
...
# <a id="tools.lemmatizer"></a>Chapter 8. Lemmatizer
...
## <a id="tools.lemmatizer.tagging.cmdline"></a>Lemmatizer Tool
...
## <a id="tools.lemmatizer.tagging.api"></a>Lemmatizer API
...
## <a id="tools.lemmatizer.training"></a>Lemmatizer Training
...
### <a id="tools.lemmatizer.training.tool"></a>Training Tool
...
### <a id="tools.lemmatizer.training.api"></a>Training API
...
## <a id="tools.lemmatizer.evaluation"></a>Lemmatizer Evaluation
...
# <a id="tools.chunker"></a>Chapter 9. Chunker
...
## <a id="tools.parser.chunking"></a>Chunking
...
### <a id="tools.parser.chunking.cmdline"></a>Chunker Tool
...
### <a id="tools.parser.chunking.api"></a>Chunking API
...
## <a id="tools.chunker.training"></a>Chunker Training
...
### <a id="tools.chunker.training.tool"></a>Training Tool
...
### <a id="tools.chunker.training.api"></a>Training API
...
## <a id="tools.chunker.evaluation"></a>Chunker Evaluation
...
### <a id="tools.chunker.evaluation.tool"></a>Chunker Evaluation Tool
...
# <a id="tools.parser"></a>Chapter 10. Parser
...
## <a id="tools.parser.parsing"></a>Parsing
...
### <a id="tools.parser.parsing.cmdline"></a>Parser Tool
...
### <a id="tools.parser.parsing.api"></a>Parsing API
...
## <a id="tools.parser.training"></a>Parser Training
...
### <a id="tools.parser.training.tool"></a>Training Tool
...
### <a id="tools.parser.training.api"></a>Training API
...
## <a id="tools.parser.evaluation"></a>Parser Evaluation
...
### <a id="tools.parser.evaluation.tool"></a>Parser Evaluation Tool
...
### <a id="tools.parser.evaluation.api"></a>Evaluation API
...
# <a id="tools.coref"></a>Chapter 11. Coreference Resolution
...
# <a id="tools.model"></a>Chapter 12. Classpath Loading of OpenNLP Models
...
## <a id="tools.model.load"></a>Loading a pre-trained OpenNLP model from the classpath
...
## <a id="tools.model.bundle"></a>Bundling a custom trained OpenNLP model for the classpath
...
# <a id="tools.extension"></a>Chapter 13. Extending OpenNLP
...
## <a id="tools.extension.writing"></a>Writing an extension
...
# <a id="tools.corpora"></a>Chapter 14. Corpora
...
## <a id="tools.corpora.conll"></a>CONLL
...
### <a id="tools.corpora.conll.2000"></a>CONLL 2000
...
#### <a id="tools.corpora.conll.2000.getting"></a>Getting the data
...
#### <a id="tools.corpora.conll.2000.converting"></a>Converting the data
...
#### <a id="tools.corpora.conll.2000.training"></a>Training
...
#### <a id="tools.corpora.conll.2000.evaluation"></a>Evaluating
...
### <a id="tools.corpora.conll.2002"></a>CONLL 2002
...
#### <a id="tools.corpora.conll.2002.getting"></a>Getting the data
...
#### <a id="tools.corpora.conll.2002.converting"></a>Converting the data
...
#### <a id="tools.corpora.conll.2002.training.spanish"></a>Training with Spanish data
...
### <a id="tools.corpora.conll.2003"></a>CONLL 2003
...
#### <a id="tools.corpora.conll.2003.getting"></a>Getting the data
...
#### <a id="tools.corpora.conll.2003.converting"></a>Converting the data (optional)
...
#### <a id="tools.corpora.conll.2003.training.english"></a>Training with English data
...
#### <a id="tools.corpora.conll.2003.evaluation.english"></a>Evaluating with English data
...
## <a id="tools.corpora.arvores-deitadas"></a>Arvores Deitadas
...
### <a id="tools.corpora.arvores-deitadas.getting"></a>Getting the data
...
### <a id="tools.corpora.arvores-deitadas.converting"></a>Converting the data (optional)
...
### <a id="tools.corpora.arvores-deitadas.evaluation"></a>Training and Evaluation
...
## <a id="tools.corpora.ontonotes"></a>OntoNotes Release 4.0
...
### <a id="tools.corpora.ontonotes.namefinder"></a>Name Finder Training
...
## <a id="tools.corpora.brat"></a>Brat Format Support
...
### <a id="tools.corpora.brat.training"></a>Training
...
### <a id="tools.corpora.brat.evaluation"></a>Evaluation
...
### <a id="tools.corpora.brat.cross-validation"></a>Cross Validation
...
# <a id="opennlp.ml"></a>Chapter 15. Machine Learning
...
## <a id="opennlp.ml.maxent"></a>Maximum Entropy
...
### <a id="opennlp.ml.maxent.impl"></a>Implementation
...
# <a id="org.apache.opennlp.uima"></a>Chapter 16. UIMA Integration
...
## <a id="org.apache.opennlp.running-pear-sample"></a>Running the pear sample in CVD
...
## <a id="org.apache.opennlp.further-help"></a>Further Help
...
# <a id="tools.morfologik-addon"></a>Chapter 17. Morfologik Addon
...
## <a id="tools.morfologik-addon.api"></a>Morfologik Integration
...
## <a id="tools.morfologik-addon.cmdline"></a>Morfologik CLI Tools
...
# <a id="tools.cli"></a>Chapter 18. The Command Line Interface
...
## <a id="tools.cli.doccat"></a>Doccat
...
### <a id="tools.cli.doccat.Doccat"></a>Doccat
...
### <a id="tools.cli.doccat.DoccatTrainer"></a>DoccatTrainer
...
### <a id="tools.cli.doccat.DoccatEvaluator"></a>DoccatEvaluator
...
### <a id="tools.cli.doccat.DoccatCrossValidator"></a>DoccatCrossValidator
...
### <a id="tools.cli.doccat.DoccatConverter"></a>DoccatConverter
...
## <a id="tools.cli.langdetect"></a>Langdetect
...
### <a id="tools.cli.langdetect.LanguageDetector"></a>LanguageDetector
...
### <a id="tools.cli.langdetect.LanguageDetectorTrainer"></a>LanguageDetectorTrainer
...
### <a id="tools.cli.langdetect.LanguageDetectorConverter"></a>LanguageDetectorConverter
...
### <a id="tools.cli.langdetect.LanguageDetectorCrossValidator"></a>LanguageDetectorCrossValidator
...
### <a id="tools.cli.langdetect.LanguageDetectorEvaluator"></a>LanguageDetectorEvaluator
...
## <a id="tools.cli.dictionary"></a>Dictionary

- [DictionaryBuilder](#tools.cli.dictionary.DictionaryBuilder)

### <a id="tools.cli.dictionary.DictionaryBuilder"></a>DictionaryBuilder
...
## <a id="tools.cli.tokenizer"></a>Tokenizer
...
### <a id="tools.cli.tokenizer.SimpleTokenizer"></a>SimpleTokenizer
...
### <a id="tools.cli.tokenizer.TokenizerME"></a>TokenizerME
...
### <a id="tools.cli.tokenizer.TokenizerTrainer"></a>TokenizerTrainer
...
### <a id="tools.cli.tokenizer.TokenizerMEEvaluator"></a>TokenizerMEEvaluator
...
### <a id="tools.cli.tokenizer.TokenizerCrossValidator"></a>TokenizerCrossValidator
...
### <a id="tools.cli.tokenizer.TokenizerConverter"></a>TokenizerConverter
...
### <a id="tools.cli.tokenizer.DictionaryDetokenizer"></a>DictionaryDetokenizer

```java
Usage: opennlp DictionaryDetokenizer detokenizerDictionary
```

## <a id="tools.cli.sentdetect"></a>Sentdetect
...
### <a id="tools.cli.sentdetect.SentenceDetector"></a>SentenceDetector
...
### <a id="tools.cli.sentdetect.SentenceDetectorTrainer"></a>SentenceDetectorTrainer
...
### <a id="tools.cli.sentdetect.SentenceDetectorEvaluator"></a>SentenceDetectorEvaluator
...
### <a id="tools.cli.sentdetect.SentenceDetectorCrossValidator"></a>SentenceDetectorCrossValidator
...
### <a id="tools.cli.sentdetect.SentenceDetectorConverter"></a>SentenceDetectorConverter
...
## <a id="tools.cli.namefind"></a>Namefind
...
### <a id="tools.cli.namefind.TokenNameFinder"></a>TokenNameFinder
...
### <a id="tools.cli.namefind.TokenNameFinderTrainer"></a>TokenNameFinderTrainer
...
| data | sampleData | No | Data to be used, usually a file name. |
| encoding | charsetName | Yes | Encoding for reading and writing text, if absent the system default is used. |
| bionlp2004 | types | DNA,protein,cell\_type,cell\_line,RNA | No |  |
| data | sampleData | No | Data to be used, usually a file name. |
| encoding | charsetName | Yes | Encoding for reading and writing text, if absent the system default is used. |
...
### <a id="tools.cli.namefind.TokenNameFinderEvaluator"></a>TokenNameFinderEvaluator
...
### <a id="tools.cli.namefind.TokenNameFinderCrossValidator"></a>TokenNameFinderCrossValidator
...
### <a id="tools.cli.namefind.TokenNameFinderConverter"></a>TokenNameFinderConverter
...
### <a id="tools.cli.namefind.CensusDictionaryCreator"></a>CensusDictionaryCreator
...
## <a id="tools.cli.postag"></a>Postag
...
### <a id="tools.cli.postag.POSTagger"></a>POSTagger
...
### <a id="tools.cli.postag.POSTaggerTrainer"></a>POSTaggerTrainer
...
### <a id="tools.cli.postag.POSTaggerEvaluator"></a>POSTaggerEvaluator
...
### <a id="tools.cli.postag.POSTaggerCrossValidator"></a>POSTaggerCrossValidator
...
### <a id="tools.cli.postag.POSTaggerConverter"></a>POSTaggerConverter
...
## <a id="tools.cli.lemmatizer"></a>Lemmatizer

- [LemmatizerME](#tools.cli.lemmatizer.LemmatizerME)
- [LemmatizerTrainerME](#tools.cli.lemmatizer.LemmatizerTrainerME)
- [LemmatizerEvaluator](#tools.cli.lemmatizer.LemmatizerEvaluator)

### <a id="tools.cli.lemmatizer.LemmatizerME"></a>LemmatizerME
...
### <a id="tools.cli.lemmatizer.LemmatizerTrainerME"></a>LemmatizerTrainerME
...
### <a id="tools.cli.lemmatizer.LemmatizerEvaluator"></a>LemmatizerEvaluator
...
## <a id="tools.cli.chunker"></a>Chunker
...
### <a id="tools.cli.chunker.ChunkerME"></a>ChunkerME
...
### <a id="tools.cli.chunker.ChunkerTrainerME"></a>ChunkerTrainerME
...
### <a id="tools.cli.chunker.ChunkerEvaluator"></a>ChunkerEvaluator
...
### <a id="tools.cli.chunker.ChunkerCrossValidator"></a>ChunkerCrossValidator
...
### <a id="tools.cli.chunker.ChunkerConverter"></a>ChunkerConverter
...
## <a id="tools.cli.parser"></a>Parser
...
### <a id="tools.cli.parser.Parser"></a>Parser
...
### <a id="tools.cli.parser.ParserTrainer"></a>ParserTrainer
...
### <a id="tools.cli.parser.ParserEvaluator"></a>ParserEvaluator
...
### <a id="tools.cli.parser.ParserConverter"></a>ParserConverter
...
### <a id="tools.cli.parser.BuildModelUpdater"></a>BuildModelUpdater
...
### <a id="tools.cli.parser.CheckModelUpdater"></a>CheckModelUpdater
...
### <a id="tools.cli.parser.TaggerModelReplacer"></a>TaggerModelReplacer
...
## <a id="tools.cli.entitylinker"></a>Entitylinker

- [EntityLinker](#tools.cli.entitylinker.EntityLinker)

### <a id="tools.cli.entitylinker.EntityLinker"></a>EntityLinker
...
## <a id="tools.cli.languagemodel"></a>Languagemodel

- [NGramLanguageModel](#tools.cli.languagemodel.NGramLanguageModel)

### <a id="tools.cli.languagemodel.NGramLanguageModel"></a>NGramLanguageModel
...
# <a id="opennlp.evaltest"></a>Chapter 19. Evaluation Test Data
...
## <a id="opennlp.evaltest.whatisit"></a>What is it ?
...
## <a id="opennlp.evaltest.whereisit"></a>Where is it?
...
## <a id="opennlp.evaltest.howtouseit"></a>How to use the evaluation test data to run test?
...
## <a id="opennlp.evaltest.howtochangeit"></a>How to change evaluation data?
